...
public class NEPAL_T20 extends Scene{

	public String broadcaster = "NEPAL_T20";
	...
	public NEPAL_T20(String scene_path, String which_Layer) {
	...
	public Infobar updateInfobar(List<Scene> scenes, MatchAllData match,boolean show_speed, PrintWriter print_writer) throws InterruptedException, IOException
	{
	...
	public Object ProcessGraphicOption(String whatToProcess, MatchAllData match, CricketService cricketService, List<MatchAllData> tournament_matches,
		...
		case "ANIMATE-IN-BALLGRIFF": case "ANIMATE-IN-BALL_PERFORMER": case "TICKER_LT_OUT": case "TICKER_LT_IN": case "ANIMATE-IN-MOST": case "ANIMATE-IN-INN_BUILDER":
			...
			case "ANIMATE-IN-IDENT":
				if(infobar.isInfobar_on_screen() == true && which_graphic_on_screen == "IDENT") {
					...
					AnimateInGraphics(print_writer, "IDENT_TOP");
				...
				if(bocf.getLast_type() != null) {
					if(bocf.getLast_type().toUpperCase().equalsIgnoreCase("PERFORMER")) {
						if(bocf.getType().toUpperCase().equalsIgnoreCase("PERFORMER")) {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll*ACTIVE SET 0 \0");
			...
			case "ANIMATE-IN-BAT-PERFORMER":
				...
				//System.out.println(bcf.getLast_type());
				//System.out.println(bcf.getType());
				...
				if(bcf.getLast_type() != null) {
					if(bcf.getLast_type().toUpperCase().equalsIgnoreCase("PARTNERSHIP")) {
						if(bcf.getType().toUpperCase().equalsIgnoreCase("PARTNERSHIP")) {
							...
							bcf.setLast_type(bcf.getType());
						}else if(bcf.getType().toUpperCase().equalsIgnoreCase("BATSTATUS")) {
					...
					}else if(bcf.getLast_type().toUpperCase().equalsIgnoreCase("BATSTATUS")) {
						if(bcf.getType().toUpperCase().equalsIgnoreCase("PARTNERSHIP")) {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatExtraData$BatPartnershipGrp*ACTIVE SET 1 \0");
			...
			case "ANIMATE-IN-SCORECARD":
				if(which_graphic_on_screen == "BATBALLSUMMARY_BOWLINGCARD" || which_graphic_on_screen == "BATBALLSUMMARY_BOWLINGCARD_PERFORMER") {
					...
					print_writer.println("-1 RENDERER*TREE*$Main$All$BattingCard*ACTIVE SET " + "1" + "\0");
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Loop START \0");
					batBowlSummaryPointsTableLogoAnim(print_writer, "BATTING");
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*BattingCardIn START \0");
				}else if(which_graphic_on_screen == "BATBALLSUMMARY_MATCHSUMMARY") {
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*SummaryOut START \0");
					print_writer.println("-1 RENDERER*TREE*$Main$All$BattingCard*ACTIVE SET " + "1" + "\0");
			...
			case "ANIMATE-IN-BOWLINGCARD":
				if(which_graphic_on_screen == "BATBALLSUMMARY_SCORECARD" || which_graphic_on_screen == "BATBALLSUMMARY_SCORECARD_PERFORMER") {
					...
					print_writer.println("-1 RENDERER*TREE*$Main$All$BowlingCard*ACTIVE SET " + "1" + "\0");
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Loop START \0");
					batBowlSummaryPointsTableLogoAnim(print_writer, "BOWLING");
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*BowlingCardIn START \0");
				}else if(which_graphic_on_screen == "BATBALLSUMMARY_MATCHSUMMARY") {
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*SummaryOut START \0");
					print_writer.println("-1 RENDERER*TREE*$Main$All$BowlingCard*ACTIVE SET " + "1" + "\0");
			...
			case "ANIMATE-IN-MATCHSUMARRY":
				if(which_graphic_on_screen == "BATBALLSUMMARY_SCORECARD" || which_graphic_on_screen == "BATBALLSUMMARY_SCORECARD_PERFORMER") {
					...
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Loop START \0");
					batBowlSummaryPointsTableLogoAnim(print_writer, "SUMMARY");
			...
			case "ANIMATE-IN-POINTSTABLE":
				if(which_graphic_on_screen == "BATBALLSUMMARY_SCORECARD" || which_graphic_on_screen == "BATBALLSUMMARY_SCORECARD_PERFORMER") {
					...
					print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Loop START \0");
					batBowlSummaryPointsTableLogoAnim(print_writer, "POINTS_TABLE");
			...
			case "ANIMATE-IN-INFOBAR":
				if(infobar.isInfobar_on_screen() == true) {
					...
					AnimateOutGraphics(print_writer, "IDENT_TOP");
		...
		case "POPULATE-FF-PLAYERPROFILEBALL": case "POPULATE-BAT_PERFORMER": case "POPULATE-LT-LINEUP": case "POPULATE-BUGPARTNERSHIP": case "POPULATE-LT-MANHATTAN":
		case "POPULATE-BT-POWERPLAY": case "POPULATE-INNING_SUMMARY": case "POPULATE-PLAYOFFS": case "POPULATE-FF-BATGRIFF": case "POPULATE-FF-BALLGRIFF": case "POPULATE-BALL_PERFORMER":
		case "POPULATE-MOST_RUNS": case "POPULATE-INN_BUILDER":
			...
			case "POPULATE-FF-BALLGRIFF":
				populateBallGriff(print_writer, valueToProcess.split(",")[0],Integer.valueOf(valueToProcess.split(",")[1]),Integer.valueOf(valueToProcess.split(",")[3]),
						CricketFunctions.extractTournamentStats("COMBINED_PAST_CURRENT_MATCH_DATA",false, tournament_matches, cricketService,match,null),cricketService.getTeams(),match, broadcaster);
				break;
			...
			case "POPULATE-LT-LINEUP":
				...
				populateLineup(print_writer, valueToProcess.split(",")[0],Integer.valueOf(valueToProcess.split(",")[1]),valueToProcess.split(",")[2],
						cricketService,cricketService.getAllPlayer(),match, broadcaster, config);
			...
			case "POPULATE-FF-MATCHSUMMARY":
				populateMatchsummary(print_writer, valueToProcess.split(",")[0], Integer.valueOf(valueToProcess.split(",")[1]), match, broadcaster,cricketService.getVariousTexts());
			...
			case "POPULATE-INNING_SUMMARY":
				populateInningSummary(print_writer, valueToProcess.split(",")[0], Integer.valueOf(valueToProcess.split(",")[1]),cricketService.getTeams(), match, broadcaster, config);
				break;
...
//					cricket_match = (CricketFunctions.populateMatchVariables(cricketService,(MatchAllData) JAXBContext.newInstance(MatchAllData.class).createUnmarshaller().
//							unmarshal(new File(CricketUtil.CRICKET_SERVER_DIRECTORY + CricketUtil.MATCHES_DIRECTORY + file.getName()))));
	...
	public void AnimateInGraphics(PrintWriter print_writer, String whichGraphic) throws InterruptedException
	{
		...
		case "BATSMAN_2_HIGHLIGHT":
			...
			break;
		case "IDENT_TOP":
			print_writer.println("-1 RENDERER*FRONT_LAYER*STAGE*DIRECTOR*InfoBar_In START \0");
			break;
		...
		case "L3MATCHID": case "TARGET": case "BUGTARGET": case "COMPARISION": case "SPLIT": case "BATSMANSTATS": case "BOWLERSTATS": case "LINEUP":
		case "BOWLERSUMMARY": case "PLAYERSUMMARY": case "TEAMSUMMARY": case "NEXTTOBAT": case "PROJECTED": case "BOWLERDETAILS": case "LTPOWERPLAY":
		case "L3PLAYERPROFILE": case "EQUATION": case "POSITION_LANDMARK": case "BATSMAN_THIS_MATCH": case "MOST": case "INN_BUILDER":
		case "BOWLER_THIS_MATCH": case "LTPOINTSTABLE": case "BOWLER_STYLE": case "BATSMAN_STYLE":case "HOWOUT_WITHOUT": case "BALLGRIFF":
		case "L3MATCH_PROMO": case "MINI_BATTINGCARD": case "MINI_BOWLINGCARD": case "THISSERIES": case "BUGPARTNERSHIP": case "LT-MANHATTAN": case "BATGRIFF":
			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*In START \0");
			break;
		
		case "LTPARTNERSHIP":case "MATCHID": case "PLAYERPROFILEBALL": 
		case "FFPLAYERPROFILE":	case "TEAMLINEUP": case "DOUBLETEAMS": case "LANDMARK":
		case "MANHATTAN": case "MOSTRUNS": case "MOSTWICKETS": case "INNING_SUMMARY":
		case "MOSTFOURS": case "MOSTSIXES": case "HIGHESTSCORE": case "WORM":  case "MATCH_PROMO": case "PARTNERSHIP": case "TEAMS_LOGO": case "TIEID-DOUBLE":
		case "SCHEDULE": case "FF-THISSERIES": case "LEADERBOARD": case "FF_STATS": case "PLAYOFFS":
		case "PLAYERPROFILEBAT":
			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*In START \0");
			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Loop START \0");
			break;	
	...
	public void AnimateOutGraphics(PrintWriter print_writer, String whichGraphic) {
		...
		case "ANIMATE-OUT-IDENT":
			...
			break;
		case "IDENT":
			print_writer.println("-1 RENDERER*FRONT_LAYER*STAGE*DIRECTOR*InfoBar_Out START \0");
			print_writer.println("-1 RENDERER*FRONT_LAYER*STAGE*DIRECTOR*IdentOut START \0");
		...
		case "IDENT_TOP":
			...
			break;	
		case "BUG-DISMISSAL": case "BUG": case "BUGBOWLER": case "BUG-DB": case "HOWOUT": case "HOWOUT_QUICK": case "NAMESUPER": case "NAMESUPER-PLAYER": case "FALLOFWICKET":
		case "L3MATCHID": case "TARGET": case "BUGTARGET": case "COMPARISION": case "LTPARTNERSHIP": case "SPLIT": case "BATSMANSTATS": case "BOWLERSTATS": case "LINEUP":
		...
		case "SCHEDULE": case "MINI_BATTINGCARD": case "MINI_BOWLINGCARD": case "THISSERIES": case "FF-THISSERIES": case "LEADERBOARD": case "FF_STATS": case "BUGPARTNERSHIP":
		case "PLAYERPROFILEBALL": case "PLAYERPROFILEBAT": case "LT-MANHATTAN": case "INNING_SUMMARY": case "PLAYOFFS": case "BATGRIFF": case "BALLGRIFF": case "MOST": case "INN_BUILDER":
			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Out START \0");
			break;
		}
	}
	...
	public void populateBatPerformer(PrintWriter print_writer, String viz_scene, int whichInning,String Type,int player, MatchAllData match, String broadcaster, Configuration config) throws InterruptedException 
	{
		if (match == null) {
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					...
					if (inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$Header$TeamNameGrp$FirstName*GEOM*TEXT SET " 
				...
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BottomInfoGrp$BottomInfoAll$ExtrasGrp$ExtrasValue*GEOM*TEXT SET " + inn.getTotalExtras() + "\0");
				TimeUnit.MILLISECONDS.sleep(2);
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BottomInfoGrp$BottomInfoAll$OversGrp$OversValue*GEOM*TEXT SET " + CricketFunctions.OverBalls(inn.getTotalOvers(),inn.getTotalBalls()) + "\0");
				TimeUnit.MILLISECONDS.sleep(2);
				if(inn.getTotalWickets() >= 10) {
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BottomInfoGrp$BottomInfoAll$TotalScore*GEOM*TEXT SET " + inn.getTotalRuns() + "\0");
					TimeUnit.MILLISECONDS.sleep(2);
				} else {
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BottomInfoGrp$BottomInfoAll$TotalScore*GEOM*TEXT SET " + 
			...
			case "BATSTATUS":
						...
						for (BattingCard bc : inn.getBattingCard()) {
							...
							if(bc.getHowOut() == null) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + 
										row + "$BatOmo*FUNCTION*Omo*vis_con SET 0 \0");
								TimeUnit.MILLISECONDS.sleep(2);
								
							}else if(bc.getHowOut().toUpperCase().equalsIgnoreCase(CricketUtil.RETIRED_HURT)) {
								
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + 
										row + "$BatOmo*FUNCTION*Omo*vis_con SET 1 \0");
								TimeUnit.MILLISECONDS.sleep(2);
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" +
										row + "$BatOmo$Dehighlight$HowOutGrp$WicketPlayerName*GEOM*TEXT SET " + "retired hurt" + "\0");
								TimeUnit.MILLISECONDS.sleep(2);
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" +
										row + "$BatOmo$Dehighlight$HowOutGrp$BallPlayerName*GEOM*TEXT SET " + " " + "\0");
								TimeUnit.MILLISECONDS.sleep(2);
								...
								TimeUnit.MILLISECONDS.sleep(2);
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" +
										row + "$BatOmo$Dehighlight$HowOutGrp$WicketPlayerName*GEOM*TEXT SET " + "absent hurt" + "\0");
								TimeUnit.MILLISECONDS.sleep(2);
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" +
										row + "$BatOmo$Dehighlight$HowOutGrp$BallPlayerName*GEOM*TEXT SET " + " " + "\0");
								TimeUnit.MILLISECONDS.sleep(2);
							...
							if(bc.getStatus().toUpperCase().equalsIgnoreCase(CricketUtil.OUT)) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + row + 
										"$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$WicketPlayerName*ACTIVE SET 1 \0");
								TimeUnit.MILLISECONDS.sleep(2);
								if(bc.getHowOut().toUpperCase().equalsIgnoreCase(CricketUtil.RETIRED_OUT)) {
										...
										if(bc.getWasHowOutFielderSubstitute() != null && bc.getWasHowOutFielderSubstitute().equalsIgnoreCase(CricketUtil.YES)) {
											print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + row + 
													"$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$WicketPlayerName*GEOM*TEXT SET " + bc.getHowOutPartOne() + " (sub - " + bc.getHowOutPartTwo().split(" ")[0] + ")" + "\0");
											print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + row + 
													"$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$BallPlayerName*GEOM*TEXT SET " + "" + "\0");
											TimeUnit.MILLISECONDS.sleep(2);
										}else {
								...
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + row + 
										"$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$WicketPlayerName*ACTIVE SET 0 \0");
								TimeUnit.MILLISECONDS.sleep(2);
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + row + 
										"$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$WicketPlayerName*GEOM*TEXT SET " + " " + "\0");
								TimeUnit.MILLISECONDS.sleep(2);
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatRightDataAll$BatRightDataGrp$BatDetailRow" + row + 
										"$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$BallPlayerName*GEOM*TEXT SET " + " " + "\0");
								TimeUnit.MILLISECONDS.sleep(2);
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BattingCardIn 1.363 BatOffsetIn 1.363 BattingRightCardIn 1.180 BatRightOffsetIn 1.180 \0");
				//print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BattingCardIn 1.363 BatOffsetIn 1.363 BattingRightCardIn 1.180 BatRightOffsetIn 1.180 BatPerformerOut 0.400 BatPartnershipOut 0.400 \0");
				break;
			case "PERFORMER":
				//print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatExtraData$BatPerformerGrp*ACTIVE SET 1 \0");
					...
					if (inn.getInningNumber() == whichInning) {
						for (BattingCard bc : inn.getBattingCard()) {
							if(player == bc.getPlayerId()) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBatExtraPlayerFirstName1" + " SET " + bc.getPlayer().getTicker_name() + "\0");
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBatExtraPlayerLastName1" + " SET " + " " + "\0");
								...
								for (Player hs : match.getSetup().getHomeSquad()) {
									if(hs.getPlayerId() == player) {
										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
											...
											if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
												this.status = CricketUtil.UNSUCCESSFUL;
											}
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatPlayerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
													inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
										}
										TimeUnit.MILLISECONDS.sleep(2);
									}
								...
								for (Player as : match.getSetup().getAwaySquad()) {
									if(as.getPlayerId() == player) {
										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
											...
											if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + as.getPhoto()  + CricketUtil.PNG_EXTENSION).exists()) {
												this.status = CricketUtil.UNSUCCESSFUL;
											}
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatPlayerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
													inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + as.getPhoto() + ".png" + "\0");
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BattingCardIn 1.363 BatOffsetIn 1.363 BatPerformerIn 0.641 \0");
			...
			case "PARTNERSHIP":
						...
						if(inn.getInningNumber() == whichInning) {
							...
							for (Player hs : match.getSetup().getHomeSquad()) {
								if(hs.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterNo()) {
									...
									if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatPartImage1" + " SET " + photo_path + 
												inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
									}else {
										if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
											this.status = CricketUtil.UNSUCCESSFUL;
										}
										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatPartImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path  + 
												inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
									}
								...
								if(hs.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getSecondBatterNo()) {
									...
									if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatPartImage2" + " SET " + photo_path + 
												inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
									}else {
										if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
											this.status = CricketUtil.UNSUCCESSFUL;
										}
										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatPartImage2" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path  + 
												inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
									}
									TimeUnit.MILLISECONDS.sleep(4);
								}
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BattingCardIn 1.363 BatOffsetIn 1.363 BatPartnershipIn 1.000 \0");
				//print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BattingCardIn 1.363 BatOffsetIn 1.363 BatPartnershipIn 1.000 BattingRightCardOut 1.300 BatPerformerOut 0.400 \0");
				break;
			}
					...
					for (BattingCard bc : inn.getBattingCard()) {
						...
						if(bc.getHowOut() == null) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format2$BatData$BatDataGrp$BatRow" + row_id + 
									"$RowAnimation$BatOmo" + "$Dehighlight$BatPlayerName*GEOM*TEXT SET " + bc.getPlayer().getTicker_name() + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format2$BatData$BatDataGrp$BatRow" + row_id + 
									"$RowAnimation$BatOmo" + "$Dehighlight$HowOutGrp$WicketPlayerName*GEOM*TEXT SET " + "absent hurt" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format2$BatData$BatDataGrp$BatRow" + row_id + 
									"$RowAnimation$BatOmo" + "$Dehighlight$HowOutGrp$BallPlayerName*GEOM*TEXT SET " + " " + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format2$BatData$BatDataGrp$BatRow" + row_id + 
									"$RowAnimation$BatOmo" + "$Dehighlight$ScoreGrp$Runs*GEOM*TEXT SET " + bc.getRuns() + "\0");
							...
							if(bc.getHowOut().toUpperCase().equalsIgnoreCase(CricketUtil.RETIRED_OUT)) {
									...
									if(bc.getWasHowOutFielderSubstitute() != null && bc.getWasHowOutFielderSubstitute().equalsIgnoreCase(CricketUtil.YES)) {
										if(CricketFunctions.checkImpactPlayerBowler(match.getEventFile().getEvents(), whichInning, bc.getHowOutFielderId()).equalsIgnoreCase(CricketUtil.YES) || 
											...
											print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format2$BatData$BatDataGrp$BatRow" + row_id + "$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$WicketPlayerName*GEOM*TEXT SET " + bc.getHowOutPartOne() + " (  " + bc.getHowOutPartTwo().split(" ")[0] + ")" + "\0");
											print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format2$BatData$BatDataGrp$BatRow" + row_id + "$RowAnimation$BatOmo" + cont_name + "$HowOutGrp$BallPlayerName*GEOM*TEXT SET " + "" + "\0");
											TimeUnit.MILLISECONDS.sleep(2);
	...
	public void populateBallPerformer(PrintWriter print_writer,String viz_scene, int whichInning,String Type,int player,MatchAllData match, String broadcaster, Configuration config) throws InterruptedException 
	{
		if (match == null) {
			...
			this.status = CricketUtil.SUCCESSFUL;
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$Header$TeamNameGrp$FirstName*GEOM*TEXT SET " 
					+ " " + "\0");
			
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$RightGrp$business6*TEXTURE*IMAGE SET "+ "IMAGE*/Default/Nepal_T20/Logos/1XBAT" +" \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType*FUNCTION*Omo*vis_con SET 0 \0");

			int row_id = 0, omo_num = 0,len=0,row = 0,length = 0;
			String cont_name= "";
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					...
					if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + 
								match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");

						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$Header$TeamNameGrp$LastName*GEOM*TEXT SET " 
								+ match.getSetup().getHomeTeam().getTeamName2().toUpperCase() + "\0");
						//TimeUnit.MILLISECONDS.sleep(2);
					} else {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + 
					...
					for (BowlingCard boc : inn.getBowlingCard()) {
						...
						case (CricketUtil.CURRENT + CricketUtil.BOWLER):
							...
							row_id = row_id + 1;
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallDataGrp$BallRow" + row_id + 
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallDataGrp$BallRow" + row_id + 
									"$RowAnimation$BallOmo" + cont_name +"$ScoreGrp$Figure*GEOM*TEXT SET " + boc.getWickets() + "-" + boc.getRuns() + "\0");
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						...
						for (BowlingCard boc : inn.getBowlingCard()) {
							if(boc.getRuns() > 0 || ((boc.getOvers()*6)+boc.getBalls()) > 0) {
								length = length + 1;
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp*FUNCTION*Omo*vis_con SET " + 
										length +"\0");
							}
							switch (boc.getStatus().toUpperCase()) {
							case (CricketUtil.OTHER + CricketUtil.BOWLER):
							...
							row = row + 1;
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
							...
							if(match.getSetup().getMatchType().equalsIgnoreCase(CricketUtil.DT20) || match.getSetup().getMatchType().equalsIgnoreCase(CricketUtil.D10) || 
								...
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow0"
							...
							if(match.getSetup().getMatchType().equalsIgnoreCase(CricketUtil.DT20) || match.getSetup().getMatchType().equalsIgnoreCase(CricketUtil.D10) || 
								...
								if(boc.getDots() < 0) {
									print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
											"$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallMaidensValue*GEOM*TEXT SET " + "0" + "\0");
								}else {
									print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
											"$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallMaidensValue*GEOM*TEXT SET " + boc.getDots() + "\0");
								}
								...
								if(boc.getMaidens() < 0) {
									...
									print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
											"$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallMaidensValue*GEOM*TEXT SET " + boc.getMaidens() + "\0");
								}
							}

							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + 
									row_id + "$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallExtraValue*GEOM*TEXT SET " + (boc.getNoBalls() + boc.getWides()) + "\0");
							
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
									"$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallOverValue*GEOM*TEXT SET " + CricketFunctions.OverBalls(boc.getOvers(),boc.getBalls()) + "\0");
							
							if(boc.getEconomyRate() != null) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
										"$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallEconomyValue*GEOM*TEXT SET " + boc.getEconomyRate() + "\0");
							}else {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format1$BallData$BallRightDataAll$BallRightDataGrp$BallDetailRow" + row + 
										"$RowAnimation$BallDetailOmo" + cont_name +"$BallDetailData$BallEconomyValue*GEOM*TEXT SET " + "-" + "\0");
							}	
						}
					}
				}
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BowlingCardIn 1.363 BallOffsetIn 1.363 BowlingRightCardIn 1.180 BallRightOffsetIn 1.180 \0");
				break;
			case "PERFORMER":
				//print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BattingCardAll$BattingCardType$Format1$BatData$BatExtraData$BatPerformerGrp*ACTIVE SET 1 \0");
					...
					if (inn.getInningNumber() == whichInning) {
						for (BowlingCard boc : inn.getBowlingCard()) {
							if(player == boc.getPlayerId()) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBallExtraPlayerLastName1" + " SET " + boc.getPlayer().getTicker_name() + "\0");
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBallExtraPlayerFirstName1" + " SET " + " " + "\0");
								...
								for (Player hs : match.getSetup().getHomeSquad()) {
									if(hs.getPlayerId() == player) {
										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
											...
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallPlayerImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
													inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
										}
										TimeUnit.MILLISECONDS.sleep(2);
									}
	...
	public void populateBowlingcard(PrintWriter print_writer,String viz_scene,boolean is_this_updating, int whichInning,MatchAllData match, String broadcaster) throws InterruptedException 
	{
		if (match == null) {
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					...
					for (BowlingCard boc : inn.getBowlingCard()) {
						if(boc.getRuns() > 0 || ((boc.getOvers()*6)+boc.getBalls()) > 0) {
							len=len+1;
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format2$BallData$BallDataGrp*FUNCTION*Omo*vis_con SET " + 
									len +"\0");
						}
						switch (boc.getStatus().toUpperCase()) {
						case (CricketUtil.OTHER + CricketUtil.BOWLER):
						...
						case (CricketUtil.CURRENT + CricketUtil.BOWLER):
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$BowlingCardAll$BowlingCardType$Format2$BallData$BallDataGrp$BallRow" + 
									row_id + "$RowAnimation$BallOmo" + cont_name +"$BallDetailData$BallExtraValue*GEOM*TEXT SET " + (boc.getNoBalls() + boc.getWides()) + "\0");
							//TimeUnit.MILLISECONDS.sleep(2);
			...
			//print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BowlingCardIn 1.363 BallOffsetIn 1.363 BattingCardOut 0.500 SummaryOut 0.500 PointsTableOut 0.500\0");
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 BowlingCardIn 1.363 BowlingCardIn$BallOffsetIn 1.363 \0");
			//TimeUnit.SECONDS.sleep(2);
		}
	}
	public void populateMatchsummary(PrintWriter print_writer, String viz_scene, int whichInning, MatchAllData match, String broadcaster,List<VariousText> vt) throws InterruptedException
	{
		if (match == null) {
		...
		int row_id = 0, max_Strap = 0, total_inn = 0,row_id_notout=0;
			...
			for(int i = 1; i <= whichInning ; i++) {
				...
				if(match.getMatch().getInning().get(i-1).getTotalWickets() >= 10) {
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + 
							"$RowAnimation$TeamNameAll$SumTeamRuns*GEOM*TEXT SET " + match.getMatch().getInning().get(i-1).getTotalRuns() + "\0");
					TimeUnit.MILLISECONDS.sleep(2);
				}else {
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + 
							"$RowAnimation$TeamNameAll$SumTeamRuns*GEOM*TEXT SET " + match.getMatch().getInning().get(i-1).getTotalRuns() + slashOrDash + 
					...
					for(BattingCard bc : match.getMatch().getInning().get(i-1).getBattingCard()) {
						if(bc.getRuns() > 0) {
							if(!bc.getStatus().toUpperCase().equalsIgnoreCase(CricketUtil.STILL_TO_BAT)) {
								...
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + "$RowAnimation$BatsmanGrp$TextAll$SumPlayerName*GEOM*TEXT SET " + bc.getPlayer().getTicker_name() + "\0");
								...
								if(row_id < 6) {
									row_id_notout = row_id - 1;
								}else if(row_id > 6) {
									row_id_notout = row_id - 2;
								}
								
								if(bc.getStatus().toUpperCase().equalsIgnoreCase(CricketUtil.NOT_OUT)) {
									print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + 
											"$RowAnimation$BatsmanGrp$TextAll$SumNotOut*ACTIVE SET 1 \0");
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumNotOut" + row_id_notout + " SET " + "NOT OUT" + "\0");
									TimeUnit.MILLISECONDS.sleep(2);
								} else {
									print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + 
											"$RowAnimation$BatsmanGrp$TextAll$SumNotOut*ACTIVE SET 0 \0");
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumNotOut" + row_id_notout + " SET " + "" + "\0");
									TimeUnit.MILLISECONDS.sleep(2);
								}
			...
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 SummaryIn 1.370 SummaryOffsetIn1 1.370 SummaryOffsetIn2 1.000 \0");
						...
						for (BattingCard bc : inn.getBattingCard()) {
							if(row_id < inn.getBattingCard().size()) {
								if(row_id == inn.getPartnerships().size()) {
									...
									print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$PartnershipAll$Data$BatDataGrp$Row" + row_id  + "$RowAnimation$RowOmo$LeftPlayerName$LeftPlayerNameText*GEOM*TEXT SET " + bc.getPlayer().getTicker_name()+" \0");
								}	
							}
							else {
								break;
		...
		if (match == null) {
			...
			for(Inning inn : match.getMatch().getInning()) {
				if(inn.getIsCurrentInning().equalsIgnoreCase(CricketUtil.YES)) {
					...
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$Info01*GEOM*TEXT SET " + "CURRENT" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$Info02*GEOM*TEXT SET " + "PARTNERSHIP" + "\0");

					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$group$Info04*GEOM*TEXT SET " + inn.getPartnerships().get(inn.getPartnerships().size() - 1).getTotalRuns() 
							+ " (" + inn.getPartnerships().get(inn.getPartnerships().size() - 1).getTotalBalls() + ")" + "\0");
					
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$Info03*GEOM*TEXT SET " + Left_Batsman + " " + inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterRuns()
							+ " (" + inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterBalls() + ")" + "\0");
					
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$group$Info05*GEOM*TEXT SET " + Right_Batsman + "  " + inn.getPartnerships().get(inn.getPartnerships().size() - 1).getSecondBatterRuns()
				...
				if (inn.getInningNumber() == whichInning) {
					...
					case "BOWLER":
						for (BowlingCard boc : inn.getBowlingCard()) {
							if(boc.getPlayerId()==playerId) {
								print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$Info01*GEOM*TEXT SET " + " " + "\0");
								print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$DataGrpAll$Data$PlayerNameGrp$Info01*GEOM*TEXT SET " + boc.getPlayer().getFirstname() + "\0");
	...
	public void populateNameSuper(PrintWriter print_writer,String viz_scene, NameSuper ns ,MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			if(ns.getSponsor() == null) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamRefName" + " SET " + logo_path + ns.getSponsor() + "\0");
			}
			
			if(ns.getSurname() != null) {
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayerFirstName" + " SET " + ns.getFirstname() + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + ns.getSurname() + "\0");
			}else {
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayerFirstName" + " SET " + "" + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + ns.getFirstname() + "\0");
			}
			...
			if(TeamId == match.getSetup().getHomeTeamId()) {
				for(Player hs : match.getSetup().getHomeSquad()) {
					if(playerId == hs.getPlayerId()) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamRefName" + " SET " + "" + "\0");
						TimeUnit.MILLISECONDS.sleep(4);
						...
						if(hs.getSurname() != null) {
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + "" + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + "" + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + hs.getFirstname() + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + hs.getSurname() + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
						}else {
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + "" + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							...
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + "" + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + hs.getFirstname() + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
						}
					}
				}
				...
				for(Player as : match.getSetup().getAwaySquad()) {
					if(playerId == as.getPlayerId()) {
						...
						if(as.getSurname() != null) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + as.getFirstname() + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + as.getSurname() + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
						}else {
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + "" + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							...
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$FirstName*GEOM*TEXT SET " + "" + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
							print_writer.println("-1 RENDERER*TREE*$Main$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET " + as.getFirstname() + "\0");
							TimeUnit.MILLISECONDS.sleep(4);
						}
					}
				}
	...
	public void populatePlayerProfile(PrintWriter print_writer,String viz_scene, int playerId,String Profile,String TypeofProfile,Statistics stats,List<Player> plyer, MatchAllData match, String broadcaster, Configuration config) throws InterruptedException
	{
		...
		if (match == null) {
			...
			this.status = CricketUtil.SUCCESSFUL;
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDEsign$RightGrp$business6*TEXTURE*IMAGE SET "+ "IMAGE*/Default/Nepal_T20/Logos/1XBAT" +" \0");
			...
			if(plyr.getTeamId() == match.getSetup().getHomeTeamId()) {
				if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
					...
					if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + plyr.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
						this.status = CricketUtil.UNSUCCESSFUL;
					}
				...
				if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
					...
					if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\\\\" + plyr.getPhoto()+ CricketUtil.PNG_EXTENSION).exists()) {
						this.status = CricketUtil.UNSUCCESSFUL;
					}
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path  + 
							match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\\\\" + plyr.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
	...
	public void populateDoubleteams(PrintWriter print_writer,String viz_scene,List<Player> plyr, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$Header$noname$SubHeader*GEOM*TEXT SET " + match.getSetup().getTournament() + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDEsign$RightGrp$business6*TEXTURE*IMAGE SET "+ "IMAGE*/Default/Nepal_T20/Logos/1XBAT" +" \0");
			TimeUnit.MILLISECONDS.sleep(2);
			for(int i = 1; i <= 2 ; i++) {
				if(i == 1) {
					...
					for(Player hs : match.getSetup().getHomeSquad()) {
						...
						if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == null) {
							...
							if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == 1) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
										"$RowAnimation$RowOmo$" + cont + "$TextAll$InternationalIcon*ACTIVE SET 1 \0");
							}else if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == 0) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
										"$RowAnimation$RowOmo$" + cont + "$TextAll$InternationalIcon*ACTIVE SET 0 \0");
							}
						}
						...
						if(hs.getCaptainWicketKeeper().equalsIgnoreCase(CricketUtil.CAPTAIN)) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$FirstName*GEOM*TEXT SET " + hs.getFirstname() + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$LastName*GEOM*TEXT SET " + hs.getSurname() + " (WK)" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$RoleIcon*ACTIVE SET 0 \0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$FirstName*GEOM*TEXT SET " + hs.getFirstname() + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$LastName*GEOM*TEXT SET " + hs.getSurname() + " (C & WK) " + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$RoleIcon*ACTIVE SET 0 \0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll1$TeamAll1$RowA" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$CaptainIcon*ACTIVE SET 0 \0");
					...
					for(Player as : match.getSetup().getAwaySquad()) {
						...
						if(plyr.get(as.getPlayerId()-1).getOverseasPlayer() == null) {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$InternationalIcon*ACTIVE SET 0 \0");
						}else {
							if(plyr.get(as.getPlayerId()-1).getOverseasPlayer() == 1) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
										"$RowAnimation$RowOmo$" + cont + "$TextAll$InternationalIcon*ACTIVE SET 1 \0");
							}else if(plyr.get(as.getPlayerId()-1).getOverseasPlayer() == 0) {
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
										"$RowAnimation$RowOmo$" + cont + "$TextAll$InternationalIcon*ACTIVE SET 0 \0");
							}
						}
						...
						if(as.getCaptainWicketKeeper().equalsIgnoreCase(CricketUtil.CAPTAIN)) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$FirstName*GEOM*TEXT SET " + as.getFirstname() + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$LastName*GEOM*TEXT SET " + as.getSurname() + " (WK) " + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$RoleIcon*ACTIVE SET 0 \0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$CaptainIcon*ACTIVE SET 0 \0");
							...
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$FirstName*GEOM*TEXT SET " + as.getFirstname() + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$NameAll$LastName*GEOM*TEXT SET " + as.getSurname() + " (C & WK) " + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$RoleIcon*ACTIVE SET 0 \0");
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$TeamLineup_Both$TeamsAll$TeamDataData$TeamAll2$TeamAll2$RowB" + row_id + 
									"$RowAnimation$RowOmo$" + cont + "$TextAll$CaptainIcon*ACTIVE SET 0 \0");
	...
	public Infobar populateInfobarIdent(Infobar infobar, boolean is_this_updating, String viz_scene,PrintWriter print_writer, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
	    ...
	    case CricketUtil.TOSS:
	    	if(infobar.isInfobar_on_screen() == true && which_graphic_on_screen == "IDENT") {
		    	...
		    	print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgIdentTeamLogo1" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + "\0");

				print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgIdentTeamLogo1" + " SET " 
						+ "IMAGE*/Default/Nepal_T20/Logos/" + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");
				...
				print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgIdentTeamLogo2" + " SET " 
										+ "IMAGE*/Default/Nepal_T20/Logos/" + match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\0");
				print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName2" + " SET " 
										+ match.getSetup().getAwayTeam().getTeamName1().toUpperCase() + "\0");
			}
	    	//print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$BottomBase_Sides$LogoGrp*ACTIVE SET 0 \0");
	    	if(match.getSetup().getTossWinningTeam() == match.getSetup().getHomeTeamId()) {
	...
	public Infobar populateInfobarTeamScore(Infobar infobar, boolean is_this_updating, PrintWriter print_writer, MatchAllData match, String broadcaster)
	{
	    ...
	    print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$BottomBase_Sides$LogoGrp*ACTIVE SET 1 \0");
		for(Inning inn : match.getMatch().getInning()) {
			if (inn.getIsCurrentInning().toUpperCase().equalsIgnoreCase(CricketUtil.YES)) {
				if(is_this_updating == false) {
					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET "  + "IMAGE*/Default/Nepal_T20/Logos/" + 
							inn.getBatting_team().getTeamName4().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET "  + "IMAGE*/Default/Nepal_T20/Logos/" + 
							inn.getBowling_team().getTeamName4().toUpperCase() + "\0");
	...
	public Infobar populateVizInfobarRight(Infobar infobar, boolean is_this_updating, PrintWriter print_writer, MatchAllData match, String broadcaster) 
	{
		...
		case "TOURNAMENT-NAME":	
			...
			print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTargetScore" + " SET " + match.getSetup().getTournament() + "\0");
	...
	public void populateMatchPromo(PrintWriter print_writer,String viz_sence_path, int match_number ,List<Team> team,List<Fixture> fix,MatchAllData match, String broadcaster) throws InterruptedException 
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$MatchId$TeamsAll$TeamData$Header$SubHeader*GEOM*TEXT SET "+ match.getSetup().getTournament() + " \0");
			...
			for(Team TM : team) {
				if(fix.get(match_number - 1).getHometeamid() == TM.getTeamId()) {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + TM.getTeamName4().toUpperCase() + "\0");
				...
				if(fix.get(match_number - 1).getAwayteamid() == TM.getTeamId()) {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + TM.getTeamName4().toUpperCase() + "\0");
	...
	public void populateMatchId(PrintWriter print_writer,String viz_scene, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\0");
	...
	public void populateLTMatchId(PrintWriter print_writer,String viz_scene, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + 
					match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + 
					match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\0");
	...
	public void populatePlayingXI(PrintWriter print_writer,String viz_scene, int TeamId,List<Player> plyr,MatchAllData match, String broadcaster, Configuration config) throws InterruptedException 
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDataGrp$Data$Header$SubHeader*GEOM*TEXT SET " 
					+ match.getSetup().getTournament() + " \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDEsign$RightGrp$noname$business6*TEXTURE*IMAGE SET "+ "IMAGE*/Default/Nepal_T20/Logos/1XBAT" +" \0");
			if(TeamId == match.getSetup().getHomeTeamId()) {
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");
				...
				for(Player hs : match.getSetup().getHomeSquad()) {
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
						...
						if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto()+ CricketUtil.PNG_EXTENSION).exists()) {
							this.status = CricketUtil.UNSUCCESSFUL;
						}
					...
					if(hs.getRole().equalsIgnoreCase(CricketUtil.BATSMAN)) {
						if(hs.getBattingStyle().equalsIgnoreCase("RHB")) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "RightHandBatsman" + CricketUtil.PNG_EXTENSION + "\0");
						}else if(hs.getBattingStyle().equalsIgnoreCase("LHB")) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "LeftHandBatsman" + CricketUtil.PNG_EXTENSION + "\0");
						}
					}else if(hs.getRole().equalsIgnoreCase(CricketUtil.BOWLER)) {
						if(hs.getBowlingStyle() == null) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "FastBowler" + CricketUtil.PNG_EXTENSION + "\0");
						}else {
							...
							case "ROB": case "RLB": case "LSL": case "WSL": case "LCH": case "RLG": case "WSR": case "LSO":
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "SpinBowlerIcon" + CricketUtil.PNG_EXTENSION + "\0");
								break;
							}
						}
						...
						if(hs.getBowlingStyle() == null) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "FastBowlerAllrounder" + CricketUtil.PNG_EXTENSION + "\0");
						}else {
							switch(hs.getBowlingStyle()) {
							case "RF": case "RFM": case "RMF": case "RM": case "RSM": case "LF": case "LFM": case "LMF": case "LM":
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "FastBowlerAllrounder" + CricketUtil.PNG_EXTENSION + "\0");
								break;
							case "ROB": case "RLB": case "LSL": case "WSL": case "LCH": case "RLG": case "WSR": case "LSO":
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "SpinBowlerAllrounder" + CricketUtil.PNG_EXTENSION + "\0");
								break;
							}
						}
						
					}else if(hs.getRole().equalsIgnoreCase(CricketUtil.WICKET_KEEPER)) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "Keeper" + CricketUtil.PNG_EXTENSION + "\0");
					}else if(hs.getRole().equalsIgnoreCase("BAT/KEEPER")) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "KeeperAllrounder" + CricketUtil.PNG_EXTENSION + "\0");
					}
					
					if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == null) {
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDataGrp$Data$TeamAll$ImagesAll$ImageGrp" + row_id + "$RowAnimation$RowOmo$" + cont + "$Flight*ACTIVE SET " + 0 + " \0");
					}else {
						if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == 1) {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDataGrp$Data$TeamAll$ImagesAll$ImageGrp" + row_id + "$RowAnimation$RowOmo$" + cont + "$Flight*ACTIVE SET " + 1 + " \0");
						}else if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == 0) {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDataGrp$Data$TeamAll$ImagesAll$ImageGrp" + row_id + "$RowAnimation$RowOmo$" + cont + "$Flight*ACTIVE SET " + 0 + " \0");
						}
					}
				...
				for(Player as : match.getSetup().getAwaySquad()) {
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
						...
						if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\\\\" + as.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
							this.status = CricketUtil.UNSUCCESSFUL;
						}
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgImage"+ row_id + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
								match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\\\\" + as.getPhoto() + ".png" + "\0");
					...
					}else if(as.getRole().equalsIgnoreCase(CricketUtil.WICKET_KEEPER)) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgRole" + row_id  + " SET " + icons_path + "Keeper" + CricketUtil.PNG_EXTENSION + "\0");
	...
	public void populateLtNextToBat(PrintWriter print_writer, String viz_scene, MatchAllData match, String session_selected_broadcaster) 
	{
		if (match == null) {
			...
			this.status = "ERROR: NextToBat's inning is null";
		} else {
	...
	public void populateLandMark(PrintWriter print_writer,String viz_scene, int whichInning, String statType, int playerId, MatchAllData match, String session_selected_broadcaster, Configuration config)
	{
						...
						for(BattingCard bc : inn.getBattingCard()) {
							if(playerId == bc.getPlayerId()) {
								...
								if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
									...
									if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBatting_team().getTeamName4() + "\\\\" + bc.getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
										this.status = CricketUtil.UNSUCCESSFUL;
									}
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
											inn.getBatting_team().getTeamName4() + "\\\\" + bc.getPlayer().getPhoto() + ".png" + "\0");
						...
						for(BowlingCard boc : inn.getBowlingCard()) {
							if(playerId == boc.getPlayerId()) {
								...
								if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
									...
									if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBowling_team().getTeamName4() + "\\\\" + boc.getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
										this.status = CricketUtil.UNSUCCESSFUL;
									}
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
											inn.getBowling_team().getTeamName4() + "\\\\" + boc.getPlayer().getPhoto() + ".png" + "\0");
		...
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 In$DataIn 1.660 In$Data1In 1.700 \0");
	}
					...
					for(BattingCard bc : inn.getBattingCard()) {
						if(playerId == bc.getPlayerId()) {
							...
							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
								...
								if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +bc.getPlayer().getFirstname() + CricketUtil.PNG_EXTENSION).exists()) {
									this.status = CricketUtil.UNSUCCESSFUL;
								}
								print_writer.println("-1 RENDERER*TREE*$Main$All$All_Player_Pic$noname$Plaer_Pic$PlayerImage*TEXTURE*IMAGE SET " + 
				...
				//if(inn.getInningNumber() == 2 && inn.getIsCurrentInning().equalsIgnoreCase("YES")) {
					...
					if(match.getSetup().getTargetOvers() == null || match.getSetup().getTargetOvers().trim().isEmpty() && match.getSetup().getTargetRuns() == 0) {
						if(match.getSetup().getMaxOvers()*6 >= 100) {
							if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("VJD")) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + " NEED " + CricketFunctions.GetTargetData(match).getTargetRuns() + " RUNS" + 
										 " TO WIN FROM "+  match.getSetup().getMaxOvers() + " OVERS (VJD)" + "\0");
							}else if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("DLS")) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + " NEED " + CricketFunctions.GetTargetData(match).getTargetRuns() + " RUNS" + 
										 " TO WIN FROM "+  match.getSetup().getMaxOvers() + " OVERS (DLS)" + "\0");
							}else {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + " NEED " + CricketFunctions.GetTargetData(match).getTargetRuns() + " RUNS" + 
							...
							if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("VJD")) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + " NEED " + CricketFunctions.GetTargetData(match).getTargetRuns() + " RUNS" + 
										 " TO WIN FROM "+  match.getSetup().getMaxOvers()*6 + " BALLS (VJD)" + "\0");
							}else if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("DLS")) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + " NEED " + CricketFunctions.GetTargetData(match).getTargetRuns() + " RUNS" + 
										 " TO WIN FROM "+  match.getSetup().getMaxOvers()*6 + " BALLS (DLS)" + "\0");
							}else {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + " NEED " + CricketFunctions.GetTargetData(match).getTargetRuns() + " RUNS" + 
	...
	public void populateFallofWicket(PrintWriter print_writer,String viz_scene,int whichInning, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT02$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET "+ match.getSetup().getAwayTeam().getTeamName2().toUpperCase() + "\0");
						TimeUnit.MILLISECONDS.sleep(2);
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamRefName" + " SET " + logo_path + match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\0");
						TimeUnit.MILLISECONDS.sleep(2);
					} else {
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT02$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET "+ match.getSetup().getHomeTeam().getTeamName2().toUpperCase() + "\0");
						TimeUnit.MILLISECONDS.sleep(2);
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamRefName" + " SET " + logo_path + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\0");
						TimeUnit.MILLISECONDS.sleep(2);
					}
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					...
					if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId() && splitValue == 30 || inn.getBowlingTeamId() == match.getSetup().getHomeTeamId() && splitValue == 50) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET "+ match.getSetup().getAwayTeam().getTeamName2().toUpperCase() + "\0");
						...
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET "+ match.getSetup().getHomeTeam().getTeamName2().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT$All$Out$FOW$BottomLine$HeadValue1$Dehiglight$StatHead1*GEOM*TEXT SET "+ splitValue + CricketFunctions.Plural(splitValue) + "\0");
					...
					if(row_no <= 5) {
						if(tournament.get(i).getPlayerId() == playerid) {
							...
							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
								...
								if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamName4() + "\\\\" + 
	...
	public void populatePointsTable(PrintWriter print_writer,String viz_scene,List<LeagueTeam> point_table, String broadcaster,MatchAllData match) throws InterruptedException 
	{
		...
		print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPointsTableSubHeader" + " SET " + match.getSetup().getTournament() + "\0");
	...
	public void populateTieIdDouble(PrintWriter print_writer,String viz_sence_path,String day,List<Fixture> fix,List<Team>team,MatchAllData match, String selectedbroadcaster) throws InterruptedException 
	{
		if (match == null) {
			...
			for(int i = 0; i <= fix.size()-1; i++) {
				if(fix.get(i).getDate().equalsIgnoreCase(Date)) {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHomeTeamRefName0" + row_id + " SET " + logo_path + team.get(fix.get(i).getHometeamid()-1).getTeamName4().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHomeTeamName0" + row_id + " SET " + team.get(fix.get(i).getHometeamid()-1).getTeamName1().toUpperCase() + "\0");
					
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfoMatch" + row + " SET " + "MATCH " + 
							fix.get(i).getMatchnumber() + " - " + fix.get(i).getGmtTime() + "\0");
					/*if(fix.get(i).getMatchnumber() == 13) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfoMatch" + row + " SET " + "SEMI-FINAL 1" + "\0");
					}else if(fix.get(i).getMatchnumber() == 14) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfoMatch" + row + " SET " + "SEMI-FINAL 2" + "\0");
					}else {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfoMatch" + row + " SET " + "MATCH " + 
								fix.get(i).getMatchnumber() + "\0");
					}*/
					
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tAwayTeamRefName0" + row_id + " SET " + logo_path + team.get(fix.get(i).getAwayteamid()-1).getTeamName4().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tAwayTeamName0" + row_id + " SET " + team.get(fix.get(i).getAwayteamid()-1).getTeamName1().toUpperCase() + "\0");
		...
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.png In 3.100 DataIn 2.900 DataIn$In 2.900\0");
	...
	public void populatePreviousSummary(PrintWriter print_writer, String viz_scene, int match_number,List<MatchAllData> mtch,List<Fixture> fix, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			for(int j = 0; j <= mtch.size() - 1; j++) {
				int row_id = 0, max_Strap = 0,row_id_notout=0;
				String teamname = "";
				...
				for(int i = 1; i <= 2 ; i++) {
					...
					if(mtch.get(j).getMatch().getInning().get(i-1).getTotalWickets() >= 10) {
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + 
								"$RowAnimation$TeamNameAll$SumTeamRuns*GEOM*TEXT SET " + mtch.get(j).getMatch().getInning().get(i-1).getTotalRuns() + "\0");
					}else {
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + 
								"$RowAnimation$TeamNameAll$SumTeamRuns*GEOM*TEXT SET " + mtch.get(j).getMatch().getInning().get(i-1).getTotalRuns() + slashOrDash 
					...
					if(mtch.get(j).getMatch().getInning().get(i-1).getBowlingCard() != null) {
						...
						for(BowlingCard boc : mtch.get(j).getMatch().getInning().get(i-1).getBowlingCard()) {
							...
							if(boc.getWickets() > 0) {
								row_id = row_id + 1;
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + "$RowAnimation$BowlerGrp*ACTIVE SET 1 \0");
								print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$AllDataGrp$AllDataGrp$SummaryAll$SummaryData$BatDataGrp$SumRow" + row_id + "$RowAnimation$BowlerGrp$TextAll$SumPlayerName*GEOM*TEXT SET " + boc.getPlayer().getTicker_name() + "\0");
	...
	public void populateManhattan(PrintWriter print_writer,String viz_scene, int whichInning, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + inn.getBatting_team().getTeamName4().toUpperCase() + "\0");
					...
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$Manhattan$Data$Header$SubHeader*GEOM*TEXT SET "+ match.getSetup().getTournament() + " \0");
		...
		if (match == null) {
			...
			for(int i =0; i < 3;i++) {
				runsIncr = maxRuns / 3; // 35/5=7 -> Y axis will be plot like 6,12,18,24,30 & 36
		 		print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$lines$PlayerNameGrp$Row" + (3 - i) + "$RowAni$Runs*GEOM*TEXT SET " + runsIncr*(i+1) + "\0");
			}
			
			for(int j = 0; j <= match.getSetup().getMaxOvers(); j++) {
				print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$BarGrp$BarAll$Bar" + (j) + "*ACTIVE SET 0" + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$BarGrp$Wickets$Wkt" + (j) + "*FUNCTION*Omo*vis_con SET " + "0" + " \0");
					
				if(j < CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).size()) {
					lngth = ((14 *Integer.valueOf(
							CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).get(j).getOverTotalRuns())) / maxRuns); // 32 is max value of each bar
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$BarGrp$BarAll$Bar" + (j) + "*ACTIVE SET 1" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$BarGrp$BarAll*FUNCTION*BarValues*Bar_Value__" + (j) + " SET " + lngth + "\0");
				
					if(CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).get(j).getOverTotalWickets() > 0) {
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$BarGrp$Wickets$Wkt" + (j) + "*FUNCTION*Omo*vis_con SET " + Integer.valueOf(
								CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).get(j).getOverTotalWickets()) + " \0");
					}
					else {
						print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$All$Mann$Man20$BarGrp$Wickets$Wkt" + (j) + "*FUNCTION*Omo*vis_con SET " + "0" + " \0");
					...
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$PositionY$All$Mann$Man20$BarGrp$BarAll$Bar" + (j) + "*ACTIVE SET 0" + "\0");
				}
			}
		}
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 2.700 In$DataIn1 0.956 In$DataIn2 0.356 \0");		
		TimeUnit.SECONDS.sleep(1);
	}
	...
	public void populateInningSummary(PrintWriter print_writer,String viz_scene, int whichInning,List<Team> team, MatchAllData match, String broadcaster, Configuration config) throws InterruptedException
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHeader1" + " SET " + match.getSetup().getMatchIdent().toUpperCase() + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHeader2" + " SET " + "INNINGS SUMMARY" + "\0");
			
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumSubHeader" + " SET " + match.getSetup().getTournament() + "\0");
			
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow1$RowAnimation$TeamNameAll$TossCoin*ACTIVE SET 0 \0");
			
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumTeamFirstName1" + " SET " + 
					match.getMatch().getInning().get(whichInning-1).getBatting_team().getTeamName2() + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumTeamLastName1" + " SET " + 
					match.getMatch().getInning().get(whichInning-1).getBatting_team().getTeamName3() + "\0");
			
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + 
					match.getMatch().getInning().get(whichInning-1).getBatting_team().getTeamName4().toUpperCase() + "\0");
			
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumTotalScore1" + " SET " + 
					match.getMatch().getInning().get(whichInning-1).getTotalRuns() + "-" + match.getMatch().getInning().get(whichInning-1).getTotalWickets() + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSumOvers1" + " SET " + 
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tEquation" + " SET " + 
					CricketFunctions.GenerateMatchSummaryStatus(2, match, CricketUtil.FULL, "|",broadcaster,true).getTargetOrResult().toUpperCase() + "\0");
			...
			if(match.getMatch().getInning().get(whichInning-1).getTotalWickets() > 0) {
				if(match.getMatch().getInning().get(whichInning-1).getBattingCard() != null) {
					...
					if(!match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getStatus().toUpperCase().equalsIgnoreCase(CricketUtil.STILL_TO_BAT)) {
						if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumBatsmanImage1" + " SET " + photo_path + 
									team.get(match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
									match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
						}else {
							if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +team.get(match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
									match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION).exists()) {
								this.status = CricketUtil.UNSUCCESSFUL;
							}
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumBatsmanImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
									team.get(match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
									match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
						}
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$TextAll$SumPlayerName*GEOM*TEXT SET " + 
								match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getPlayer().getTicker_name() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$TextAll$ScoreGrp$BatPlayerRun*GEOM*TEXT SET " + 
								match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getRuns() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$BoundaryGrp$BoundaryValue*GEOM*TEXT SET " + 
						...
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$StrikeRateGrp$StrikeRateValue*GEOM*TEXT SET " + 
						...
						if(match.getMatch().getInning().get(whichInning-1).getBattingCard().get(0).getStatus().toUpperCase().equalsIgnoreCase(CricketUtil.NOT_OUT)) {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$TextAll$NotOutStar*ACTIVE SET 1 \0");
							TimeUnit.MILLISECONDS.sleep(2);
						} else {
							print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$TextAll$NotOutStar*ACTIVE SET 0 \0");
							TimeUnit.MILLISECONDS.sleep(2);
						}
						
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BatsmanGrp$TextAll$ScoreGrp$BatPlayerBall*GEOM*TEXT SET " + 
				...
				if(match.getMatch().getInning().get(whichInning-1).getBowlingCard() != null) {
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumBowlerImage1" + " SET " + photo_path + 
								team.get(match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
								match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
					}else {
						if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +team.get(match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
								match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION).exists()) {
							this.status = CricketUtil.UNSUCCESSFUL;
						}
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumBowlerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
								team.get(match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
								match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
					}
					...
					TimeUnit.MILLISECONDS.sleep(2);
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BowlerGrp$TextAll$EconomyGrp$EconomyValue*GEOM*TEXT SET " + 
							match.getMatch().getInning().get(whichInning-1).getBowlingCard().get(0).getEconomyRate() + "\0");
					TimeUnit.MILLISECONDS.sleep(2);
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BowlerGrp$TextAll$DotsGrp$DotsValue*GEOM*TEXT SET " + 
				...
				if(match.getMatch().getInning().get(whichInning-1).getBattingCard() != null) {
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
						...
						if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumBatsmanImage1" + " SET " + photo_path + 
									team.get(match.getMatch().getInning().get(whichInning-1).getBattingCard().get(1).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
									match.getMatch().getInning().get(whichInning-1).getBattingCard().get(1).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
						}else {
							if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +team.get(match.getMatch().getInning().get(whichInning-1).getBattingCard().get(1).getPlayer().getTeamId() - 1).getTeamName4()  + "\\\\" + 
						...
						TimeUnit.MILLISECONDS.sleep(2);
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BowlerGrp$TextAll$EconomyGrp$EconomyHead*GEOM*TEXT SET " + 
								"4s/6s :" + "\0");
						TimeUnit.MILLISECONDS.sleep(2);
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BowlerGrp$TextAll$EconomyGrp$Economy*GEOM*TEXT SET " + 
						...
						TimeUnit.MILLISECONDS.sleep(2);
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BowlerGrp$TextAll$EconomyGrp$DotsHead*GEOM*TEXT SET " + 
								"S/R :" + "\0");
						TimeUnit.MILLISECONDS.sleep(2);
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$BatDataGrp$SumRow2$RowAnimation$BowlerGrp$TextAll$DotsGrp$DotsValue*GEOM*TEXT SET " + 
			...
			for(int i =0; i < 5;i++) {
				runsIncr = maxRuns / 5; // 35/5=7 -> Y axis will be plot like 6,12,18,24,30 & 36
		 		print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$PlayerNameGrp$Row" + (5 - i) + "$RowAni$Runs*GEOM*TEXT SET " + runsIncr*(i+1) + "\0");
			}
			
			for(int j = 0; j <= match.getSetup().getMaxOvers(); j++) {
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$BarGrp$BarAll$Bar" + (j) + "*ACTIVE SET 0" + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$BarGrp$Wickets$Wkt" + (j) + "*FUNCTION*Omo*vis_con SET " + "0" + " \0");
					
				if(j < CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).size()) {
					lngth = ((35 *Integer.valueOf(
							CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).get(j).getOverTotalRuns())) / maxRuns); // 32 is max value of each bar
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$BarGrp$BarAll$Bar" + (j) + "*ACTIVE SET 1" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$BarGrp$BarAll*FUNCTION*BarValues*Bar_Value__" + (j) + " SET " + lngth + "\0");
				
					if(CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).get(j).getOverTotalWickets() > 0) {
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$BarGrp$Wickets$Wkt" + (j) + "*FUNCTION*Omo*vis_con SET " + Integer.valueOf(
								CricketFunctions.getOverByOverData(match, whichInning,"MANHATTAN" ,match.getEventFile().getEvents()).get(j).getOverTotalWickets()) + " \0");
					}
					else {
						print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$InninSummary$SummaryData$Manhattan$BarGrp$Wickets$Wkt" + (j) + "*FUNCTION*Omo*vis_con SET " + "0" + " \0");
		...
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.100 In$DataIn 2.840 \0");
		TimeUnit.SECONDS.sleep(2);
	...
	public void populateWorm(PrintWriter print_writer,String viz_scene, int whichInning, MatchAllData match, String broadcaster) throws InterruptedException
	{
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$TeamsAll$TeamDataData$BottomInfoGrp$RowAnimation$Equations*GEOM*TEXT SET "+ 
					CricketFunctions.GenerateMatchSummaryStatus(whichInning, match, CricketUtil.FULL, "|",broadcaster,true).getTargetOrResult().toUpperCase() + " \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$TeamsAll$TeamDataData$Header$SubHeader*GEOM*TEXT SET "+ match.getSetup().getTournament() + " \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDEsign$Left$LeaftBaseGrp$LeftLogo$LeftLogo*TEXTURE*IMAGE SET "
					+ logo_path + "TLogo" + CricketUtil.PNG_EXTENSION + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/NEPAL_T20/Logos/" + "TLogo" + "\0");
			...
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp2$Band*MATERIAL*COLOR SET 0.0 0.478431372549 0.811764705882 \0");
			
			/*print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp1$TextAll$TeamName*MATERIAL*COLOR_ENABLE SET 1 \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp1$TextAll$ScoreGrp$Score*MATERIAL*COLOR_ENABLE SET 1 \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp1$TextAll$ScoreGrp$Overs*MATERIAL*COLOR_ENABLE SET 1 \0");
			
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp1$TextAll$TeamName*MATERIAL*COLOR SET 0.0 0.0 0.0 1.0 \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp1$TextAll$ScoreGrp$Score*MATERIAL*COLOR SET 0.0 0.0 0.0 1.0 \0");
			print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Row2$RowAnimation$TeamGrp1$TextAll$ScoreGrp$Overs*MATERIAL*COLOR SET 0.0 0.0 0.0 1.0 \0");*/
			...
			for(int inn_count = 1; inn_count <= whichInning; inn_count++)
			{
				...
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Man20$InningsGraphGrp$InningsGraph1*GEOM*DataXOffset SET 2.0 \0");
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Man20$InningsGraphGrp$InningsGraph2*GEOM*DataXOffset SET 2.0 \0");
				
				Lngth =  (80.62 / maxRuns); // 100 is max value of each bar
				
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Man20$InningsGraphGrp$InningsGraph1*GEOM*DataXScale" + " SET " + "1.0" + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$WormAll$WormAll$WormGrp$Man20$InningsGraphGrp$InningsGraph2*GEOM*DataXScale" + " SET " + "1.0" + "\0");
	...
	public void populateMiniBattingcard(PrintWriter print_writer, String viz_scene, int whichInning, MatchAllData match, String broadcaster) throws InterruptedException {
		...
		if (match == null) {
			...
			TimeUnit.MILLISECONDS.sleep(200);
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 1.180 In$BatDataIn 1.200 \0");
	...
	public void populateLineup(PrintWriter print_writer,String viz_scene,int team_id,String icon_data,CricketService cricketService,List<Player> plyr,MatchAllData match, 
		...
		case "ICON":
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamFirstName" + " SET " + match.getSetup().getMatchIdent().toUpperCase() + "\0");
			
			if(team_id == match.getSetup().getHomeTeamId()) {
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamLastName" + " SET " + match.getSetup().getHomeTeam().getTeamName2() + "\0");
				for(Player hs : match.getSetup().getHomeSquad()) {
					row_id = row_id + 1;
					print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll*FUNCTION*Omo*vis_con SET 0 \0");
					
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayerName" + row_id  + " SET " + hs.getTicker_name() + "\0");
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
					...
					if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == null) {
						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll$Icons$InternationalIcon*ACTIVE SET 0 \0");
					}else {
						if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == 1) {
							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll$Icons$InternationalIcon*ACTIVE SET 1 \0");
						}else if(plyr.get(hs.getPlayerId()-1).getOverseasPlayer() == 0) {
							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll$Icons$InternationalIcon*ACTIVE SET 0 \0");
						}
					}
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamLastName" + " SET " + match.getSetup().getAwayTeam().getTeamName2() + "\0");
				for(Player as : match.getSetup().getAwaySquad()) {
					row_id = row_id + 1;
					print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll*FUNCTION*Omo*vis_con SET 0 \0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayerName" + row_id  + " SET " + as.getTicker_name() + "\0");
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_id + " SET " + photo_path + 
								match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\\\\" + as.getPhoto() + ".png" + "\0");
					}else {
		...
		case "BATTING_CARD":
			for(Inning inn : match.getMatch().getInning()) {
				if(inn.getBattingTeamId() == team_id) {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamFirstName" + " SET " + match.getSetup().getMatchIdent().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamLastName" + " SET " + inn.getBatting_team().getTeamName2() + "\0");
					Collections.sort(inn.getBattingCard());
					for(BattingCard bc : inn.getBattingCard()) {
						row_id = row_id + 1;
						if(bc.getStatus().equalsIgnoreCase(CricketUtil.STILL_TO_BAT)) {
							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll*FUNCTION*Omo*vis_con SET 1 \0");
							
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayerName" + row_id  + " SET " + plyr.get(bc.getPlayerId()-1).getTicker_name() + "\0");
							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_id + " SET " + photo_path + 
										inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + plyr.get(bc.getPlayerId()-1).getPhoto() + ".png" + "\0");
							}else {
								if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ASSAM\\Photos\\" +inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + plyr.get(bc.getPlayerId()-1).getPhoto()+ CricketUtil.PNG_EXTENSION).exists()) {
									this.status = CricketUtil.UNSUCCESSFUL;
								}
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_id + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path  + 
										inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + plyr.get(bc.getPlayerId()-1).getPhoto() + ".png" + "\0");
							...
							if(plyr.get(bc.getPlayerId() - 1).getBattingStyle() != null) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBatHand" + row_id + " SET " + plyr.get(bc.getPlayerId() - 1).getBattingStyle().toUpperCase() + "\0");
							}else {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBatHand" + row_id + " SET " + " " + "\0");
							}
							
							if(inn.getInningStatus().equalsIgnoreCase(CricketUtil.START)) {
								print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll$StrikeRateGrp$StrikeRateText*GEOM*TEXT SET " + "IN AT" + "\0");
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStrikeRate" + row_id + " SET " + bc.getBatterPosition() + "\0");
							}else if(inn.getInningStatus().equalsIgnoreCase(CricketUtil.PAUSE)) {
								print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll$StrikeRateGrp$StrikeRateText*GEOM*TEXT SET " + " " + "\0");
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStrikeRate" + row_id + " SET " + "DNB" + "\0");
							}
							
						}else if(bc.getStatus().equalsIgnoreCase(CricketUtil.NOT_OUT) || bc.getStatus().equalsIgnoreCase(CricketUtil.OUT)) {
							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Teams$Data$Rows$Row" + row_id + "$RowAnimation$RowOmo$TextAll*FUNCTION*Omo*vis_con SET 2 \0");
							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_id + " SET " + photo_path + 
										inn.getBatting_team().getTeamName4().toUpperCase() + "\\\\" + plyr.get(bc.getPlayerId()-1).getPhoto() + ".png" + "\0");
							}else {
		...
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 1.320 \0");
		TimeUnit.SECONDS.sleep(1);
	}
		...
		case "NEPAL_T20":
			...
			for(int i = 0; i <= top_ten_beststat.size() - 1 ; i++) {
				if(top_ten_beststat.get(i).getPlayer().getPlayerId() == PlayerId) {
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "C:\\\\Images\\\\NEPAL_T20\\\\Photos\\\\" + 
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + 
							team.get(top_ten_beststat.get(i).getPlayer().getTeamId() - 1).getTeamName4().toUpperCase() + "\0");
	
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tVersusTeamName" + row_no + " SET " + "v " + top_ten_beststat.get(i).getOpponentTeam().getTeamName2().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamFirstName" + " SET " + top_ten_beststat.get(i).getPlayer().getFirstname() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamLastName" + " SET " + top_ten_beststat.get(i).getPlayer().getSurname() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSubHeader" + " SET " + "MATCHES" + "\0");
			...
			for(Inning inn : match.getMatch().getInning()) {
				...
				if(inn.getIsCurrentInning().equalsIgnoreCase(CricketUtil.YES)) {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead3" + " SET " + "TOTAL RUNS " + "\0");
			...
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 2.474 In$DataIn 1.100 \0");
			//this.status = CricketUtil.SUCCESSFUL;
			break;
		}
	}
		...
		case "NEPAL_T20":
			...
			for(int i = 0; i <= top_bowler_beststats.size() - 1 ; i++) {
				if(top_bowler_beststats.get(i).getPlayer().getPlayerId() == PlayerId) {
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/Nepal_T20/Logos/" + 
							team.get(top_bowler_beststats.get(i).getPlayer().getTeamId() - 1).getTeamName4().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main$AllGrp$All$AllDEsign$RightGrp$RightTeamLogos$RightLogo$RightLogo*TEXTURE*IMAGE SET 0 \0");
					
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tVersusTeamName" + row_no + " SET " + "v " + top_bowler_beststats.get(i).getOpponentTeam().getTeamName2().toUpperCase() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamFirstName" + " SET " + top_bowler_beststats.get(i).getPlayer().getFirstname() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamLastName" + " SET " + top_bowler_beststats.get(i).getPlayer().getSurname() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSubHeader" + " SET " + "MATCHES" + "\0");
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead3" + " SET " + "TOTAL WICKETS" + "\0");
				...
				if (inn.getInningNumber() == whichInning) {
					...
					for(BattingCard bc : inn.getBattingCard()) {
						if(playerId == bc.getPlayerId()) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT$All$Out$PlayerNameGrp$TeamNameGrp$LastName*GEOM*TEXT SET "+ 
					...
					print_writer.println("-1 RENDERER*TREE*$Main$All_Grp$PositionY$LT$All$Out$FOW$BottomLine$HeadValue1$Dehiglight$StatHead1*GEOM*TEXT SET "+ 
							20 + CricketFunctions.Plural(20) + " \0");
