    ...
    <div class="content py-5" style="background-color: #EAE8FF; color: #2E008B">    
        <div class="container">
            ...
            <div class="tab-content" id="pills-tabContent">
	            ...
	            <thead >
	                <tr>
	                    <th class="table-header" colspan="14">INFOBAR</th>
	                </tr>
	            </thead>
	            <tbody>
	            	 <tr>
                  	...
                  	<div class="screenshot-section" id="infoTable2">
				            ...
				            <tbody>
				               ...
				               <tr>
					               ...
					               <td class="table-cell-black">DLS PAR SCORE<td class="table-cell-blue">ALT+D</td>
					               <td class="table-cell-black">TODAY'S MATCH</td><td class="table-cell-blue">ALT+J</td>
				       ...
				       <div class="tab-pane fade" id="pills-mini-keys" role="tabpanel" aria-labelledby="pills-mini-keys-tab">
				        	...
				        	<table class="table table-bordered">
					            <thead>
					                <tr>
					                    <th class="table-header" colspan="20">MINI'S</th>
					                </tr>
					            </thead>
					            <tbody>
						            <tr>
