...
public class LCT extends Scene{

	public String broadcaster = "LCT";
	public Infobar infobar = new Infobar();
	public String which_graphics_onscreen = "";
	private String slashOrDash = "-";
	public String status;
	public String director;
	private String logo_path = "C:\\\\Images\\\\LCT\\\\Logos\\\\";
	private String photo_path = "C:\\\\Images\\\\LCT\\\\Photos\\\\";
	private String local_photo_path = "\\\\c\\\\Images\\\\LCT\\\\Photos\\\\";
	...
	public LCT(String scene_path, String which_Layer) {
			...
			throws JAXBException, InterruptedException, NumberFormatException, ParseException, IllegalAccessException, InvocationTargetException, IOException
	{
		...
		case "POPULATE-PLAYOFF": case "POPULATE-FF-SCHEDULE": case "POPULATE-SIX": case "POPULATE-FOUR": 
			...
			case "LOAD_MANUAL_XML_SCENE":
				scenes.set(2, new Scene("/Default/LCT/" + valueToProcess.replace(".xml", ""),"MIDDLE_LAYER"));
			...
			default:
				...
				switch (whatToProcess.toUpperCase()) {
				case "POPULATE-FOUR": 
					populatetournamentFour(print_writer, valueToProcess.split(",")[0],tournament_matches,match, broadcaster);
//					System.out.println("Four = " + CricketFunctions.gettournamentFoursAndSixes(tournament_matches, match));
					break;
				case "POPULATE-SIX":
					populatetournamentSix(print_writer, valueToProcess.split(",")[0],tournament_matches,match, broadcaster);
//					System.out.println("Four = " + CricketFunctions.gettournamentFoursAndSixes(tournament_matches, match));
					break;	
				...
				case "POPULATE-FF-SCORECARD":
					...
					if(which_graphics_onscreen == "BATBALLSUMMARY_BOWLINGCARD" || which_graphics_onscreen == "BATBALLSUMMARY_MATCHSUMMARY" || which_graphics_onscreen == "POINTSTABLE") {	
						...
						if(which_graphics_onscreen == "BATBALLSUMMARY_BOWLINGCARD") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 BattingCardIn 1.676 BowlingCardOut 0.700 \0");
						}else if(which_graphics_onscreen == "BATBALLSUMMARY_MATCHSUMMARY") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 BattingCardIn 1.676 SummaryOut 0.700 \0");
						}else if(which_graphics_onscreen == "POINTSTABLE") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 BattingCardIn 1.676 PointsTableOut 0.700 \0");
						}
				...
				case "POPULATE-FF-BOWLINGCARD":
					...
					if(which_graphics_onscreen == "BATBALLSUMMARY_SCORECARD" || which_graphics_onscreen == "BATBALLSUMMARY_MATCHSUMMARY" || which_graphics_onscreen == "POINTSTABLE") {	
						...
						if(which_graphics_onscreen == "BATBALLSUMMARY_SCORECARD") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 BowlingCardIn 1.740 BattingCardOut 0.700 \0");
						}else if(which_graphics_onscreen == "BATBALLSUMMARY_MATCHSUMMARY") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 BowlingCardIn 1.740 SummaryOut 0.700 \0");
						}else if(which_graphics_onscreen == "POINTSTABLE") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 BowlingCardIn 1.740 PointsTableOut 0.700 \0");
						}
					}
					break;
				...
				case "POPULATE-FF-MATCHSUMMARY":
					...
					if(which_graphics_onscreen == "BATBALLSUMMARY_SCORECARD" || which_graphics_onscreen == "BATBALLSUMMARY_BOWLINGCARD" || which_graphics_onscreen == "POINTSTABLE") {	
						...
						if(which_graphics_onscreen == "BATBALLSUMMARY_SCORECARD") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 SummaryIn 1.316 BattingCardOut 0.700 \0");
						}else if(which_graphics_onscreen == "BATBALLSUMMARY_BOWLINGCARD") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 SummaryIn 1.316 BowlingCardOut 0.700 \0");
						}else if(which_graphics_onscreen == "POINTSTABLE") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 SummaryIn 1.316 PointsTableOut 0.700 \0");
						}
					}
					
					break;
				case "POPULATE-FF-LEADERBOARD":
					populateMost(print_writer, valueToProcess.split(",")[0], valueToProcess.split(",")[1], Integer.valueOf(valueToProcess.split(",")[2]),
							CricketFunctions.extractTournamentStats("COMBINED_PAST_CURRENT_MATCH_DATA",false, tournament_matches, cricketService,match,null),
				...
				case "POPULATE-TIEID-DOUBLE":
					...
					populateTieIdDouble(print_writer, valueToProcess.split(",")[0],valueToProcess.split(",")[1],cricketService.getFixtures(),cricketService.getTeams(), match, broadcaster);
					break;
				...
				case "POPULATE-POINTS_TABLE":
					...
					if(which_graphics_onscreen == "BATBALLSUMMARY_SCORECARD" || which_graphics_onscreen == "BATBALLSUMMARY_BOWLINGCARD" || which_graphics_onscreen == "BATBALLSUMMARY_MATCHSUMMARY") {	
						...
						if(which_graphics_onscreen == "BATBALLSUMMARY_SCORECARD") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 PointsTableIn 1.400 BattingCardOut 0.700 \0");
						}else if(which_graphics_onscreen == "BATBALLSUMMARY_BOWLINGCARD") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 PointsTableIn 1.400 BowlingCardOut 0.700 \0");
						}else if(which_graphics_onscreen == "BATBALLSUMMARY_MATCHSUMMARY") {
							print_writer.println("-1 RENDERER PREVIEW SCENE*" + valueToProcess.split(",")[0] + " C:/Temp/Preview.jpeg In 3.500 PointsTableIn 1.400 SummaryOut 0.700 \0");
						}
					}
					break;
...
//									cricket_match.setEvents(cricket_event.getEvents());
...
//					AnimateInGraphics(print_writer, "RESET");
		...
		case "ANIMATE-IN-SCHEDULE": case "ANIMATE-IN-FOUR": case "ANIMATE-IN-SIX":
...
//					AnimateInGraphics(print_writer, "FF_IN");
			...
			case "ANIMATE-IN-LTPARTNERSHIP": case "ANIMATE-IN-BUGTARGET": case "ANIMATE-IN-BOWLERSUMMARY": case "ANIMATE-IN-NEXT_TO_BAT": case "ANIMATE-IN-BOWLERDETAILS": case "ANIMATE-IN-LTPOWERPLAY":
			case "ANIMATE-IN-LANDMARK":	case "ANIMATE-IN-EQUATION": case "ANIMATE-IN-POSITION_LANDMARK": case "ANIMATE-IN-BATSMAN_THIS_MATCH": case "ANIMATE-IN-BOWLER_THIS_MATCH": case "ANIMATE-IN-SCHEDULE":
			...
			case "ANIMATE-IN-MOSTRUNS": case "ANIMATE-IN-MOSTWICKETS": case "ANIMATE-IN-MOSTFOURS": case "ANIMATE-IN-MOSTSIXES": case "ANIMATE-IN-HIGHESTSCORE": case "ANIMATE-IN-L3MATCH_PROMO": case "CLEAR-ALL":
			case "ANIMATE-IN-WORM":	case "ANIMATE-IN-BUG_POWERPLAY": case "ANIMATE-IN-MANUAL_GRAPHIC": case "ANIMATE-IN-BATGRIFF": case "ANIMATE-IN-BALLGRIFF": case "ANIMATE-IN-PLAYOFF":
			case "ANIMATE-IN-FOUR": case "ANIMATE-IN-SIX":	
			...
			case "ANIMATE-IN-FOUR":
				AnimateInGraphics(print_writer, "FOUR");
				which_graphics_onscreen = "FOUR";
				break;
			case "ANIMATE-IN-SIX":
				AnimateInGraphics(print_writer, "SIX");
...
//					}
			...
			case "CLEAR-ALL":
               ...
               print_writer.println("-1 RENDERER*FRONT_LAYER SET_OBJECT SCENE*/Default/LCT/ScoreBug\0");
			...
			case "ANIMATE-OUT":
				...
				case "SIX":
					AnimateOutGraphics(print_writer, "SIX");
					TimeUnit.SECONDS.sleep(1);
					which_graphics_onscreen = "";
					resetInfobarAnimation(print_writer,broadcaster);
					break;
				case "FOUR":
					AnimateOutGraphics(print_writer, "FOUR");
					TimeUnit.SECONDS.sleep(1);
					which_graphics_onscreen = "";
					resetInfobarAnimation(print_writer,broadcaster);
					break;
		...
		case "LCT":
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getInningNumber() == whichInning) {
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatSponsor" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + " " + "\0");

					if (inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase()+ "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$BattingCard$MaxSize$BatHeader*GEOM*TEXT SET " + match.getSetup().getHomeTeam().getTeamName1().toUpperCase() + "\0");
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
			...
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 0.740 BattingCardIn 1.676 \0");
//			TimeUnit.SECONDS.sleep(2);
			break;
		}
		...
		case "LCT":
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						...
						//print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBatting_team().getTeamName4().toUpperCase() + "\0");
						...
						for (BattingCard bc : inn.getBattingCard()) {
							...
							switch (bc.getStatus().toUpperCase()) {
								...
								print_writer.println("-1 RENDERER*TREE*$Main$All$AllDataGrp$BattingData$DataAll$DataGrp$Row" + row_id + 
										"$RowAni$RowOmo" + cont_name + "$ScoreGrp$BatsmanScore*GEOM*TEXT SET " + bc.getRuns()+(bc.getStatus().equalsIgnoreCase("NOT OUT") ?"*":"") + "\0");
								print_writer.println("-1 RENDERER*TREE*$Main$All$AllDataGrp$BattingData$DataAll$DataGrp$Row" + row_id + 
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 1.481 BatDataIn 1.180 \0");
			break;
		}
	}
		...
		case "LCT":
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallSponsor" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + " " + "\0");
	
						if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 BowlingCardIn 1.740 \0");
				TimeUnit.SECONDS.sleep(2);
			break;
		}
	}
			...
			if (match == null) {
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$All$TopPart$LogoMotion*ACTIVE SET 0 \0");
						//print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBowling_team().getTeamName4().toUpperCase() + "\0");
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 1.241 \0");
			...
			if (match == null) {
				...
				for(Inning inn : match.getMatch().getInning()) {
					...
					//if (inn.getIsCurrentInning().equalsIgnoreCase(CricketUtil.YES)) {
						...
						if (inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
						} else {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
						}
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 DataIn 1.640 BallOffsetIn 1.830 ManDataIn 0.460 DataIn 1.570 \0");
				TimeUnit.SECONDS.sleep(2);
				//this.status = CricketUtil.SUCCESSFUL;
			}
			break;
	...
	public void populateMatchsummary(PrintWriter print_writer, String viz_scene, int whichInning, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "LCT":
			...
			int row_id = 0, max_Strap = 0, total_inn = 0;
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumSponsor" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + " " + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumSponsor" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + " " + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$Shriram_Logo*ACTIVE SET 0 \0");
				print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$BatTeamLogo*TEXTURE*IMAGE SET " + logo_path + "\\" + "LCT.png" +" \0");
				...
				for(int i = 1; i <= whichInning ; i++) {
					...
					if(match.getMatch().getInning().get(i-1).getBattingTeamId() == match.getSetup().getHomeTeamId()) {
						teamname = match.getSetup().getHomeTeam().getTeamName3();
						teamname_logo  = match.getSetup().getHomeTeam().getTeamName3().toUpperCase();
					} else {
						teamname = match.getSetup().getAwayTeam().getTeamName3();
						teamname_logo = match.getSetup().getAwayTeam().getTeamName3().toUpperCase();
					}
					
					
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumTeamBadge" + i + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teamname_logo + "\0");
					...
					if(match.getMatch().getInning().get(i-1).getTotalWickets() >= 10) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row"+row_id+"$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " + match.getMatch().getInning().get(i-1).getTotalRuns() 
								+ slashOrDash + String.valueOf(match.getMatch().getInning().get(i-1).getTotalWickets()) + "\0");	
					}
				...
				if(match.getMatch().getMatchResult() != null) {
					if(match.getMatch().getMatchResult().toUpperCase().equalsIgnoreCase("")) {
						print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row9$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " 
									+ CricketFunctions.GenerateMatchSummaryStatus(whichInning, match, CricketUtil.SHORT, "|",broadcaster,true).getTargetOrResult().toUpperCase() + " \0");
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 SummaryIn 1.316 \0");
				TimeUnit.SECONDS.sleep(2);
				//this.status = CricketUtil.SUCCESSFUL;	
	...
	public void populateTeamsLogo(PrintWriter print_writer,String viz_scene, List<Team> teams ,MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "LCT":
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 \0");
			TimeUnit.SECONDS.sleep(2);
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + " SET " + " " + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
...
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo1" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teams.get(1).getTeamName3().toUpperCase() + "\0");
...
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo2" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teams.get(2).getTeamName3().toUpperCase() + "\0");
...
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo3" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teams.get(3).getTeamName3().toUpperCase() + "\0");
...
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo4" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teams.get(4).getTeamName3().toUpperCase() + "\0");
...
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo5" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teams.get(5).getTeamName3().toUpperCase() + "\0");
...
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo6" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teams.get(6).getTeamName3().toUpperCase() + "\0");
...
//			
	...
	public void populateBugDismissal(PrintWriter print_writer,String viz_scene, int whichInning, String statsType, int playerId, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "LCT":
			if (match == null) {
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 0.714 \0");
				//this.status = CricketUtil.SUCCESSFUL;	
			}
			break;
		}
		...
		case "LCT":
			if (match == null) {
				...
				if(bug.getText1() != null && bug.getText2() != null) {
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo1" + " SET " + "" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo2" + " SET " + "" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo3" + " SET " + bug.getText1() + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo4" + " SET " + "" + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo1" + " SET " + "" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo2" + " SET " + "" + "\0");
	...
	public void populatePlayerProfile(PrintWriter print_writer,String viz_scene, int playerId,String TypeofProfile,String Profile,Statistics stats, MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "LCT":
			...
			if(plyr.getTeamId() == match.getSetup().getHomeTeamId()) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + match.getSetup().getHomeTeam().getTeamName4() + "\\\\" + plyr.getPhoto() + ".png" + "\0");
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + match.getSetup().getAwayTeam().getTeamName4() + "\\\\" + plyr.getPhoto() + ".png" + "\0");
			...
			if (match == null) {
				...
				for(int i = 1; i <= 2 ; i++) {
					if(i == 1) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSponsor" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
								+ "LCT" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge1" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
								+ match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
						/*print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$DataAll$TeamAll1$TeamNameGrp$RowAni$Highlight$Rectangle*TEXTURE*IMAGE SET " + 
								"IMAGEDefault/LCT/Logos/" + "LCT" + ".png" + "\0");*/
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge2" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
								+ match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
			...
			if (match == null) {
				...
				if(TeamId == match.getSetup().getHomeTeamId()) {
					for(int i = 1; i <= 2 ; i++) {
						if(i == 1) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + " \0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + " \0");
					...
					for(int i = 1; i <= 2 ; i++) {
						if(i == 1) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + " \0");
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + " \0");
	...
	public void populateInfobarIdent(PrintWriter print_writer,String viz_scene, String Ident, MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "LCT":
			...
			case "TOSS":
				...
				print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgIdentTeamLogo1" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
				print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgIdentTeamLogo2" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
			...
			for(Inning inn : match.getMatch().getInning()) {
				if (inn.getIsCurrentInning().toUpperCase().equalsIgnoreCase(CricketUtil.YES)) {
					if(is_this_updating == false) {
						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBatting_team().getTeamName3().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBatting_team().getTeamName3().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBowling_team().getTeamName3().toUpperCase() + "\0");
					}
		...
		case "LCT":
			...
			case "TO_WIN":
				if ((CricketFunctions.GetTargetData(match).getRemaningRuns() > 0) && (CricketFunctions.GetTargetData(match).getRemaningBall() > 0) 
					...
					CricketFunctions.GenerateMatchSummaryStatus(2, match, CricketUtil.SHORT, "|",broadcaster,true).getTargetOrResult().toUpperCase() + "\0");
				}
	...
	public List<BattingCard> populateInfobarTopLeft(boolean is_this_updating, PrintWriter print_writer, String TopLeftStats, MatchAllData match, String session_selected_broadcaster,List<BattingCard> infobar_batsman) throws InterruptedException
	{
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getIsCurrentInning().toUpperCase().equalsIgnoreCase(CricketUtil.YES)) {
						...
						if(batsman != null && batsman.size() >= 1) {
							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBatsmanName1 " + batsman.get(0).getPlayer().getTicker_name().toUpperCase() + ";");
							...
							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBatsmanName2 " + batsman.get(1).getPlayer().getTicker_name().toUpperCase() + ";");
							...
							if(infobar_batsman != null && infobar_batsman.size() >= 1) {
								...
								if(infobar_batsman.get(1).getStatus().equalsIgnoreCase(CricketUtil.OUT)) {	
									...
									processAnimation(print_writer, "Batsman2DeHighlight", "SHOW 0.0", session_selected_broadcaster);
								}
							}
	...
	public void populateInfobarBottom(boolean is_this_updating, PrintWriter print_writer, String BottomStats, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		switch (session_selected_broadcaster.toUpperCase()) {
		case "DOAD_IN_HOUSE_EVEREST":
	...
	public void populateInfobarDirector(PrintWriter print_writer,String Dir_value,String session_selected_broadcaster) {
		...
		case "DOAD_IN_HOUSE_EVEREST":
			...
			case "FREE-HIT":
				processAnimation(print_writer, "FreeHitIn", "START", session_selected_broadcaster);
				break;
			}
			break;
		case "LCT":
	...
	public void populateMatchPromo(PrintWriter print_writer,String viz_sence_path, int match_number ,List<Team> team,List<Fixture> fix,MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "LCT":
			if (match == null) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$AllTeamBadges$T10Logo*TEXTURE*IMAGE SET "+ "C:\\\\Images\\\\LCT\\\\LOGOS\\\\LCT.png" + " \0");
				...
				for(Team TM : team) {
					if(fix.get(match_number - 1).getHometeamid() == TM.getTeamId()) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + TM.getTeamName3().toUpperCase() + "\0");
					}
					if(fix.get(match_number - 1).getAwayteamid() == TM.getTeamId()) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + TM.getTeamName3().toUpperCase() + "\0");
					}
				}
...
//					print_writer.println("-1 RENDERER*TREE*$Main$All$noname$MatchId*GEOM*TEXT SET "+ "MATCH " + fix.get(match_number - 1).getMatchnumber() + " \0");
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.jpeg In 3.500 \0");
				//this.status = CricketUtil.SUCCESSFUL;	
				TimeUnit.SECONDS.sleep(2);
			}
			break;
		...
		case "LCT":
			if (match == null) {
				...
				for(Team TM : team) {
					if(fix.get(match_number - 1).getHometeamid() == TM.getTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName01" + " SET " + TM.getTeamName1().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + TM.getTeamName4().toUpperCase() + "\0");
					}
					if(fix.get(match_number - 1).getAwayteamid() == TM.getTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName02" + " SET " + TM.getTeamName1().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + TM.getTeamName4().toUpperCase() + "\0");
					}
				}
				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$Info*GEOM*TEXT SET "+ "LIVE FROM " + match.getSetup().getVenueName().toUpperCase() + " \0");
	...
	public void populateMatchId(PrintWriter print_writer,String viz_scene, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "LCT":
			if (match == null) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$Shriram_Logo*ACTIVE SET "+ "0" + " \0");
				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$AllTeamBadges$T10Logo*TEXTURE*IMAGE SET "+ logo_path + "LCT" + CricketUtil.PNG_EXTENSION + " \0");
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
	...
	public void populateLTMatchId(PrintWriter print_writer,String viz_scene, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "LCT":
			if (match == null) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
						+ match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
						+ match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
				...
				if(TeamId == match.getSetup().getHomeTeamId()) {
					...
					for(Player hs : match.getSetup().getHomeSquad()) {
						...
						if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
							...
							if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" +match.getSetup().getHomeTeam().getTeamName4() + "\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
								this.status = CricketUtil.UNSUCCESSFUL;
							}
							print_writer.println("-1 RENDERER*TREE*$Main$All$Data$ImageAll$Image" + row_id + "$PlayerImage*TEXTURE*IMAGE SET "+ "\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" 
									+ match.getSetup().getHomeTeam().getTeamName4() + "\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION + " \0");
						}
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + " \0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + " \0");
					...
					for(Player as : match.getSetup().getAwaySquad()) {
						...
						if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
							...
							if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" +match.getSetup().getAwayTeam().getTeamName4() + "\\" + as.getPhoto()  + CricketUtil.PNG_EXTENSION).exists()) {
								this.status = CricketUtil.UNSUCCESSFUL;
							}
			...
			if (match == null) {
				...
				for(Inning inn : match.getMatch().getInning()) {
					if(inn.getInningNumber() == 1 & inn.getIsCurrentInning().equalsIgnoreCase("YES")) {
						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET "+ " " + " \0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBatting_team().getTeamName3().toUpperCase() + "\0");
...
//					}
					...
					for(Inning inn : match.getMatch().getInning()) {
						...
						if (inn.getInningNumber() == whichInning) {
							...
							for(BowlingCard boc : inn.getBowlingCard()) {
								...
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBowling_team().getTeamName3().toUpperCase() + "\0");
		...
		case "LCT":
			if (match == null) {
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId() && splitValue == 30 || inn.getBowlingTeamId() == match.getSetup().getHomeTeamId() && splitValue == 50) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + " SET " + match.getSetup().getAwayTeam().getTeamName3().toUpperCase() + "\0");
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + " SET " + match.getSetup().getHomeTeam().getTeamName3().toUpperCase() + "\0");
		...
		if (match == null) {
			...
			for(Inning inn : match.getMatch().getInning()) {
				if(inn.getIsCurrentInning().equalsIgnoreCase(CricketUtil.YES)) {
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + teamname_logo + "\0");
					...
					for (Player hs : match.getSetup().getHomeSquad()) {
						if(hs.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterNo()) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + teamname + "\\\\" + hs.getPhoto() + ".png" + "\0");
						}
						if(hs.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getSecondBatterNo()) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage2" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + teamname + "\\\\" + hs.getPhoto() + ".png" + "\0");
						}
					}
					...
					for (Player as : match.getSetup().getAwaySquad()) {
						if(as.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterNo()) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + teamname + "\\\\" + as.getPhoto() + ".png" + "\0");
						}
						if(as.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getSecondBatterNo()) {
							...
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage2" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + teamname + "\\\\" + as.getPhoto() + ".png" + "\0");
						}
					}
			...
			MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		if (match == null) {
			...
			case "LCT":
					...
					for(int i = 0; i <= tournament.size() - 1 ; i++) {
						...
						if(row_no < 6) {
							...
							if(tournament.get(i).getPlayerId() == playerid) {
								...
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + "C:\\\\Images\\\\LCT\\\\Photos\\\\" + 
				...
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 2.474 In$DataIn 1.180 \0");
				//this.status = CricketUtil.SUCCESSFUL;
				TimeUnit.SECONDS.sleep(2);
				break;
	...
	public void populateLandMark(PrintWriter print_writer,String viz_scene, int whichInning, String statType, int playerId, MatchAllData match, String session_selected_broadcaster, Configuration config) throws InterruptedException
	{
		switch (session_selected_broadcaster.toUpperCase()) {
		case "LCT":
			if (match == null) {
								...
								if(playerId == bc.getPlayerId()) {
									...
									if(inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
										...
										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
											...
											if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" +match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + bc.getPlayer().getFirstname().toUpperCase()  + CricketUtil.PNG_EXTENSION).exists()) {
												this.status = CricketUtil.UNSUCCESSFUL;
											}
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
													+ "\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\"  + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION + "\0");
										}
									}
									else {
										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
								...
								if(playerId == boc.getPlayerId()) {
									...
									if(inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
										...
										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
											...
											if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION).exists()) {
												this.status = CricketUtil.UNSUCCESSFUL;
											}
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
													+ "\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + "\0");
										}
									}
									else {
										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" 
								...
								if(inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
									...
									for(Player hs : match.getSetup().getHomeSquad()) {
										if(hs.getPlayerId() == playerId) {
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
													+ "C:\\\\Images\\\\LCT\\\\Photos\\\\" + match.getSetup().getHomeTeam().getTeamName4().toUpperCase() + "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
										}
									}
								}
								else {
									...
									for(Player as : match.getSetup().getAwaySquad()) {
										if(as.getPlayerId() == playerId) {
											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
													+ "C:\\\\Images\\\\LCT\\\\Photos\\\\" + match.getSetup().getAwayTeam().getTeamName4().toUpperCase() + "\\\\" + as.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
										}
									}
								}
							}
	...
	public void populateLtEquation(PrintWriter print_writer,String viz_scene, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "LCT":
			if (match == null) {
				...
				for(Inning inn : match.getMatch().getInning()) {
					if(inn.getInningNumber() == 2 && inn.getIsCurrentInning().equalsIgnoreCase("YES")) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBatting_team().getTeamName3().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET "+ inn.getBatting_team().getTeamName1().toUpperCase() + " \0");
	...
	public void populatePointsTable(PrintWriter print_writer,String viz_sence_path,List<LeagueTeam> point_table, String session_selected_broadcaster,MatchAllData match) throws InterruptedException 
	{
		...
		case "LCT":
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPointsLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
			...
			for(int i = 0; i <= point_table.size() - 1 ; i++) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPointsTeamBadge" + row_id + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + point_table.get(i).getTeamName().toUpperCase().trim() + "\0");
			...
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.jpeg In 3.500 PointsTableIn 1.400 \0");
			TimeUnit.SECONDS.sleep(2);
			//this.status = CricketUtil.SUCCESSFUL;
			break;
		}
	...
	public void populateBowlerStyle(PrintWriter print_writer,String viz_scene, int whichInning, int playerId,List<Player> plyr, List<Team> team, MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "LCT":
			if (match == null) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + team.get(plyr.get(playerId - 1).getTeamId() - 1).getTeamName3().toUpperCase() + "\0");
...
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "LIVE FROM " + match.getVenueName() + "\0");
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "TODAY'S MATCHES " + "\0");
			}
			else if(day.toUpperCase().equalsIgnoreCase("TOMORROW")) {
				cal.add(Calendar.DATE, +1);
				Date =  new SimpleDateFormat("dd-MM-yyyy").format(cal.getTime());
				
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "TOMORROW'S MATCHES " + "\0");
			}
...
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON tTime2 SET AT 1:30 PM \0");
			...
			for(int i = 0; i <= fix.size()-1; i++) {
				if(fix.get(i).getDate().equalsIgnoreCase(Date)) {
					...
					System.out.println(team.get(fix.get(i).getHometeamid()-1).getTeamName3().toUpperCase());
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + row_id + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + 
							team.get(fix.get(i).getHometeamid()-1).getTeamName3().toUpperCase() + "\0");
					...
					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + row_id + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + 
							team.get(fix.get(i).getAwayteamid()-1).getTeamName3().toUpperCase() + "\0");
			...
			if (match == null) {
				...
				for(int j = 0; j <= mtch.size() - 1; j++) {
					...
					for(int i = 1; i <= 2 ; i++) {
						...
						row_id = row_id + 1;
						print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$SummaryHeader*GEOM*TEXT SET " + "SUMMARY - " + fix.get(match_number - 1).getMatchfilename() + "\0");
						
						
						if(mtch.get(j).getMatch().getInning().get(i-1).getBattingTeamId() == mtch.get(j).getSetup().getHomeTeamId()) {
							teamname = mtch.get(j).getSetup().getHomeTeam().getTeamName3();
							teamname_logo  = mtch.get(j).getSetup().getHomeTeam().getTeamName3().toUpperCase() ;
						} else {
							teamname = mtch.get(j).getSetup().getAwayTeam().getTeamName3();
	...
	public void populateLtMatchPromo(PrintWriter print_writer,String viz_sence_path, int match_number ,List<Team> team,List<Fixture> fix,MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "LCT":
			if (match == null) {
				...
				for(Team TM : team) {
					if(fix.get(match_number - 1).getHometeamid() == TM.getTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + TM.getTeamName3().toUpperCase() + "\0");
					...
					if(fix.get(match_number - 1).getAwayteamid() == TM.getTeamId()) {
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + TM.getTeamName3().toUpperCase() + "\0");
	...
	public void populateGeneric(PrintWriter print_writer,String viz_scene,String Stats, MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "DOAD_IN_HOUSE_EVEREST":
			if (match == null) {
				...
				print_writer.println("LAYER1*EVEREST*GLOBAL SNAPSHOT_PATH C:/Temp/Preview.jpeg;");
			...
			if (match == null) {
				...
				for(Inning inn : match.getMatch().getInning()) {
					if (inn.getInningNumber() == whichInning) {
						...
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + inn.getBatting_team().getTeamName3().toUpperCase() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + " SET " + inn.getBatting_team().getTeamName1().toUpperCase() + "\0");
	...
	public void populateWorm(PrintWriter print_writer,String viz_scene, int whichInning, MatchAllData match, String session_selected_broadcaster)
	{
		...
		case "LCT":
			if (match == null) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/LCT/Logos/LCT" + "\0");
			...
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 In$DataIn 1.780 \0");
	...
	public void populateHighestScore(PrintWriter print_writer,String viz_scene,List<Tournament> tournament_high_score,MatchAllData match ,String session_selected_broadcaster) throws InterruptedException 
	{
		...
		case "LCT":
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHeader" + " SET " + "HIGHEST INDIVIDUAL SCORE" + "\0");
	 		print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHeader" + " SET " + "HIGHEST INDIVIDUAL SCORE" + "\0");
	 		print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgLogo" + " SET " + "IMAGE*/Default/LCT_2023/Logos/" + "LCT" + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + match.getSetup().getTournament().toUpperCase() + "\0");
	...
	public void populateSchedule(PrintWriter print_writer,String viz_scene,List<Fixture> fixture,List<Team> team,MatchAllData match ,String broadcaster) throws ParseException, InterruptedException {
	...
	public void populateMost(PrintWriter print_writer,String viz_scene,String StatType,int playerid,List<Tournament> tournament,List<Team> team,MatchAllData match, String broadcaster, Configuration config) 
	{
		if (match == null) {
			this.status = "ERROR: Match is null";
		} else if (match.getMatch().getInning() == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + logo_path + "LCT.png" + " \0");

			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSubHead" + " SET " + "THIS SERIES" + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tScore" + " SET " + "" + "\0");
			...
			case "MOST_RUNS":
				...
				for(int i = 0; i <= tournament.size() - 1 ; i++) {
					...
					if(row_no <= 3) {
						if(tournament.get(i).getPlayerId() == playerid) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "HighlightSelection" + " SET " + 1 + "\0");
						}else {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "HighlightSelection" + " SET " + 0 + "\0");
						}
						
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "002" + " SET " + 
								"" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "003" + " SET " + 
								"RUNS" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "004" + " SET " + 
								"MATCHES" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "005" + " SET " + 
								"BEST" + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "006" + " SET " + 
								"S/R" + "\0");
						
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatHead" + row_no + "A" + " SET " + 
								tournament.get(i).getPlayer().getFull_name() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "B" + " SET " + 
								tournament.get(i).getRuns() + "\0");
						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "C" + " SET " + tournament.get(i).getMatches() + "\0");
						
						for(int j = 0; j <= top_ten_beststat.size() - 1 ; j++) {
							if(top_ten_beststat.get(j).getPlayerId() == tournament.get(i).getPlayerId()) {
								if(top_ten_beststat.get(j).getBestEquation() % 2 == 0) {
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "D" + " SET " + 
											top_ten_beststat.get(j).getBestEquation() / 2 + "\0");
								}else {
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "D" + " SET " + 
											top_ten_beststat.get(j).getBestEquation() / 2 + "*" + "\0");
								}
						...
						if(tournament.get(i).getBallsFaced() == 0 || tournament.get(i).getRuns()== 0) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "E" + " SET " + "-" + "\0");
						}else {
							strike_rate = tournament.get(i).getRuns() * 100;
							strike_rate = strike_rate/tournament.get(i).getBallsFaced();
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "E" + " SET " + df.format(strike_rate) + "\0");
						}
					}
				}
				break;
			case "MOST_WICKETS":
				List<BestStats> top_beststat = new ArrayList<BestStats>();
				for(Tournament tourn : tournament) {
					for(BestStats bs : tourn.getBowler_best_Stats()) {
						top_beststat.add(bs);
					}
				}
				Collections.sort(top_beststat, new CricketFunctions.PlayerBestStatsComparator());
				...
				for(int i = 0; i <= tournament.size() - 1 ; i++) {
					...
					if(row_no <= 3) {	
						...
						for(int j=0;j<= top_beststat.size()-1;j++) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead4" + " SET " + "BEST" + "\0");
							if(top_beststat.get(j).getPlayerId() == tournament.get(i).getPlayerId()) {
								if(top_beststat.get(j).getBestEquation() % 1000 > 0) {
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "D" + " SET " + 
											((top_beststat.get(j).getBestEquation() / 1000) +1) + "-" + (1000 - (top_beststat.get(j).getBestEquation() % 1000)) + "\0");
								}else {
									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "D" + " SET " + 
											(top_beststat.get(j).getBestEquation() / 1000) + "-" + Math.abs(top_beststat.get(j).getBestEquation()) + "\0");
								}
								break;
							}
//							}else if(top_beststat.get(j).getPlayerId() != tournament.get(i).getPlayerId()) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "D" + " SET " + 
//										"-" + "\0");
//							}
						}
						
						if(tournament.get(i).getBallsBowled() == 0 || tournament.get(i).getRunsConceded() == 0) {
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "E" + " SET " + "-" + "\0");
						}else {
							economy_rate = (tournament.get(i).getRunsConceded()*1.00) /tournament.get(i).getBallsBowled();
							economy_rate = economy_rate * 6;
							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "StatValue" + row_no + "E" + " SET " + df.format(economy_rate) + "\0");
						}
					}
				}
				break;
					...
					if(row_no < 6) {	
						if(tournament.get(i).getPlayerId() == playerid) {
							...
							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
								...
								if(!new File("\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\" + team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamName4() + "\\\\" + 
										tournament.get(i).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION).exists()) {
									this.status = CricketUtil.UNSUCCESSFUL;
								}
								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\LCT\\Photos\\"  + 
										team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamName4() + "\\\\" + 
										tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
							}
						}else {
	...
	public void populatetournamentFour(PrintWriter print_writer, String viz_scene,List<MatchAllData> tourn_matches,MatchAllData match, String session_selected_broadcaster) throws InterruptedException {
		switch (session_selected_broadcaster.toUpperCase()) {
		case "LCT":
			//print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tRuns" + " SET " + CricketFunctions.gettournamentFoursAndSixes(tourn_matches, match).split(",")[0] + "\0");
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 1.200 Change_In 0.460 \0");
			break;
		}
	}
	public void populatetournamentSix(PrintWriter print_writer, String viz_scene,List<MatchAllData> tourn_matches,MatchAllData match, String session_selected_broadcaster) throws InterruptedException {
		switch (session_selected_broadcaster.toUpperCase()) {
		case "LCT":
			//print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tRuns" + " SET " + CricketFunctions.gettournamentFoursAndSixes(tourn_matches, match).split(",")[1] + "\0");
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 1.200 Change_In 0.460 \0");
			break;
		}
	}
	...
	public void AnimateInGraphics(PrintWriter print_writer, String whichGraphic) throws InterruptedException
	{
		...
		case "MINI-SCORECARD": case "MINI-BOWLINGCARD": case "BUG_POWERPLAY": case "LEADERBOARD": case "MANUAL": case "BATGRIFF": case "BALLGRIFF": case "PLAYOFF": case "SCHEDULE":
			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*In START \0");
			//this.status = CricketUtil.SUCCESSFUL;
			break;
		case "FOUR": case "SIX":
	...
	public void PreviewFullFrame(PrintWriter print_writer,String viz_scene,String previous_gfx, String current_gfx)
	{
		...
		if(previous_gfx == "")
		{
			switch(current_gfx){
			case "SCORECARD":
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 BattingCardIn 1.676 \0");
				break;
			case "BOWLINGCARD":
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 BowlingCardIn 1.740 \0");
				break;
			case "MATCHSUMMARY":
				...
				break;
			case "POINTSTABLE":
				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg In 3.500 PointsTableIn 1.400 \0");
				break;
			}		
		} else {
			switch(previous_gfx){
			...
			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.jpeg " + previewAnim + " \0");
		}
	}
}
