...
public class EVEREST_KCL_T20 extends Scene{

	public String broadcaster = "EVEREST_KCL_T20";
	public String status;
	public String slashOrDash = "-";
	//public String logo_path_ns = "C:\\\\Images\\\\KERALA\\\\Logos\\\\";
	public String photo_path = "C:\\Images\\KERALA\\Photos\\";
	private String local_photo_path = "c\\Images\\KERALA\\Photos\\";
	public String logo_path = "C:\\Images\\KERALA\\Logos\\";
	...
	public EVEREST_KCL_T20() {
		super();
	}

	public EVEREST_KCL_T20(String scene_path, String which_Layer) {
			...
			PrintWriter print_writer, List<Scene> scenes, String valueToProcess, List<Statistics> statistics, Configuration config) throws InterruptedException, ParseException, JAXBException, IllegalAccessException, InvocationTargetException, IOException
	{
		...
		case "ANIMATE-IN-BUG": case "ANIMATE-IN-HOWOUT": case "ANIMATE-IN-POINTERS":
		...
		case "ANIMATE-IN-TOURNAMENT_BATTING": case "ANIMATE-IN-TOURNAMENT_BOWLING": case "ANIMATE-IN-TOURNAMENT_TEAM":
		case "ANIMATE-IN-TEAM_TOURNAMENT":
			...
			case "ANIMATE-IN-SPLIT-DB":
				...
				break;
			case "ANIMATE-IN-TOURNAMENT_BATTING":
				processAnimation(print_writer, "In", "START", broadcaster);
				which_graphic_on_screen = "TOURNAMENT_BATTING";
				break;
			case "ANIMATE-IN-TOURNAMENT_BOWLING":
				processAnimation(print_writer, "In", "START", broadcaster);
				which_graphic_on_screen = "TOURNAMENT_BOWLING";
				break;
			case "ANIMATE-IN-TOURNAMENT_TEAM":
				processAnimation(print_writer, "In", "START", broadcaster);
				which_graphic_on_screen = "TOURNAMENT_TEAM";
				break;
			case "ANIMATE-IN-TEAM_TOURNAMENT":
				processAnimation(print_writer, "In", "START", broadcaster);
				which_graphic_on_screen = "TEAM_TOURNAMENT";
				break;	
...
//				AnimateInGraphics(print_writer, "MULTI-PARTNERSHIP");
			...
			case "ANIMATE-IN-POINTERS":
				processAnimation(print_writer, "In", "START", broadcaster);
				which_graphic_on_screen = "POINTERS_LT";
				break;
			case "CLEAR-ALL":
			...
			case "ANIMATE-OUT":
				...
				case "NAMESUPER_SINGLE":
					...
					break;
				case "POINTERS_LT":
					AnimateOutGraphics(print_writer, "POINTERS_LT");
					TimeUnit.SECONDS.sleep(1);
				...
				case "BUG_POWERPLAY":
					...
					which_graphic_on_screen = "";
					break;
				case "TOURNAMENT_BATTING":
					AnimateOutGraphics(print_writer, "TOURNAMENT_BATTING");
					TimeUnit.SECONDS.sleep(1);
					
					which_graphic_on_screen = "";
					break;
				case "TOURNAMENT_BOWLING":
					AnimateOutGraphics(print_writer, "TOURNAMENT_BOWLING");
					TimeUnit.SECONDS.sleep(1);
					
					which_graphic_on_screen = "";
					break;
				case "TOURNAMENT_TEAM":
					AnimateOutGraphics(print_writer, "TOURNAMENT_TEAM");
					TimeUnit.SECONDS.sleep(1);
					
					which_graphic_on_screen = "";
					break;
				case "TEAM_TOURNAMENT":
					AnimateOutGraphics(print_writer, "TEAM_TOURNAMENT");
					TimeUnit.SECONDS.sleep(1);
...
//					print_writer.println("-1 RENDERER*STAGE SHOW 0.0 \0");
			...
			case "POPULATE-L3-SPLIT-DB":
				...
				break;
			case "POPULATE-TOURNAMENT_BATTING":	
				populateTournamentBatting(print_writer, valueToProcess, broadcaster);
				break;
			case "POPULATE-TOURNAMENT_BOWLING":	
				populateTournamentBowling(print_writer, valueToProcess, broadcaster);
				break;
			case "POPULATE-TOURNAMENT_TEAM":	
				populateTournamentTeam(print_writer, valueToProcess, broadcaster);
				break;
			case "POPULATE-TEAM_TOURNAMENT":	
				populateTeamTournament(print_writer, valueToProcess, broadcaster);
				break;	
...
//				break;	
	...
	public void AnimateOutGraphics(PrintWriter print_writer, String whichGraphic) throws InterruptedException
	{
		...
		case "FF_GRAPHICS": case "LT_GRAPHICS":	case "TOURNAMENT_BATTING":	case "TOURNAMENT_BOWLING":	case "TOURNAMENT_TEAM":	case "TEAM_TOURNAMENT": case "POINTERS_LT": 
	...
	public void populatePointers(PrintWriter printWriter,String viz_scene, Pointers Pt ,MatchAllData match, String session_selected_broadcaster) throws InterruptedException
	{
		...
		case "EVEREST_KCL_T20":
			...
			if(Pt.getTeam() != null){
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgLogo " + logo_path + Pt.getTeam() + CricketUtil.PNG_EXTENSION + ";");
			}else {
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgLogo " + logo_path + "TLogo.png" + ";");
			} 
			
			if(Pt.getText1() != null && Pt.getText2() != null && Pt.getText3() != null) {
				
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET vCoumms " + "3" + ";");
				
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tData01 "
						+ Pt.getText1() + ";");
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tData02 "
						+ Pt.getText2() + ";");
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tData03 "
						+ Pt.getText3() + ";");
				
				
			}else if(Pt.getText1() != null && Pt.getText2() != null) {
				
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET vCoumms " + "2" + ";");
				...
				printWriter.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET vCoumms " + "1" + ";");
							...
							for (BattingCard bc : inn.getBattingCard()) {
								if (bc.getPlayerId() == playerId) {
									...
									if(bc.getHowOut().toUpperCase().equalsIgnoreCase(CricketUtil.RUN_OUT)) {
										...
										if(bc.getWasHowOutFielderSubstitute() != null && bc.getWasHowOutFielderSubstitute().equalsIgnoreCase(CricketUtil.YES)) {
											print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo1A "
													+ "c (sub - "+bc.getHowOutFielder().getTicker_name()+")  "+ bc.getHowOutPartTwo() + ";");
										}else {
											print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo1A "
													+ bc.getHowOutText() + ";");
										}
...
//													+ "Over" + CricketFunctions.Plural(Integer.valueOf(CricketFunctions.OverBalls(boc.getOvers(), boc.getBalls()))) + ";");
	...
	public void populateTournamentBatting(PrintWriter print_writer, String viz_scene,String session_selected_broadcaster) throws InterruptedException {
		switch (session_selected_broadcaster.toUpperCase()) {
		case "EVEREST_KCL_T20":
			print_writer.println("LAYER1*EVEREST*GLOBAL PREVIEW ON;");
			print_writer.println("LAYER1*EVEREST*STAGE*DIRECTOR*In STOP;");
	...
	public void populateTournamentBowling(PrintWriter print_writer, String viz_scene,String session_selected_broadcaster) throws InterruptedException {
		switch (session_selected_broadcaster.toUpperCase()) {
		case "EVEREST_KCL_T20":
			print_writer.println("LAYER1*EVEREST*GLOBAL PREVIEW ON;");
			print_writer.println("LAYER1*EVEREST*STAGE*DIRECTOR*In STOP;");
	...
	public void populateTournamentTeam(PrintWriter print_writer, String viz_scene,String session_selected_broadcaster) throws InterruptedException {
		switch (session_selected_broadcaster.toUpperCase()) {
		case "EVEREST_KCL_T20":
			print_writer.println("LAYER1*EVEREST*GLOBAL PREVIEW ON;");
			print_writer.println("LAYER1*EVEREST*STAGE*DIRECTOR*In STOP;");
	...
	public void populateTeamTournament(PrintWriter print_writer, String viz_scene,String session_selected_broadcaster) throws InterruptedException {
		switch (session_selected_broadcaster.toUpperCase()) {
		case "EVEREST_KCL_T20":
			print_writer.println("LAYER1*EVEREST*GLOBAL PREVIEW ON;");
			print_writer.println("LAYER1*EVEREST*STAGE*DIRECTOR*In STOP;");
				...
				for(int i = 0; i <= tournament.size() - 1 ; i++) {
					if(team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamName1().equalsIgnoreCase(StatType.toUpperCase())) {
						if(tournament.get(i).getRuns() > 0) {
							row_no = row_no + 1;
							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgLogo " + logo_path + team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamBadge() + 
									CricketUtil.PNG_EXTENSION + ";");
							...
							if(row_no<10) {
								...
								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row_no + "A " + tournament.get(i).getPlayer().getTicker_name() + ";");
								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row_no + "B " + tournament.get(i).getMatches() + ";");
								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row_no + "C " + tournament.get(i).getRuns() + ";");
								if(tournament.get(i).getBallsFaced() == 0 || tournament.get(i).getRuns() == 0) {
	...
	public void populateMatchId(PrintWriter print_writer, String viz_scene, MatchAllData match,
		...
		case "EVEREST_KCL_T20":
			if (match == null) {
				...
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHead " + match.getSetup().getTournament() + ", " + 
...
//						+ match.getSetup().getTournament() + ";");
				...
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + "LIVE FROM "
		...
		case "EVEREST_KCL_T20":
			if (match == null) {
				...
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgHomeLogo " + logo_path
						+ match.getSetup().getHomeTeam().getTeamBadge().toUpperCase() + CricketUtil.PNG_EXTENSION + ";");
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomeFirstName " + 
						match.getSetup().getHomeTeam().getTeamName2() + ";");
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomeLastName " + 
						match.getSetup().getHomeTeam().getTeamName3() + ";");
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tAwayFirstName " + 
						match.getSetup().getAwayTeam().getTeamName2() + ";");
				print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tAwayLastName " + 
				...
				for(VariousText vtext : vartxt) {
					if(vtext.getVariousType().equalsIgnoreCase("LT_MATCH_ID") && vtext.getUseThis().equalsIgnoreCase(CricketUtil.YES)) {
						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + vtext.getVariousText() + ";");
					}else {
						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + "LIVE FROM "
								+ match.getSetup().getVenueName().toUpperCase() + ";");
					}
		...
		case "EVEREST_KCL_T20":
			if (match == null) {
				...
				if(ns.getSponsor() != null) {
					...
					print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgLogo " + logo_path
							+ "TLogo_02" + CricketUtil.PNG_EXTENSION + ";");
				}
...
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "vHighlight" + row_no + " SET " + 1 + "\0");
							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
								...
								if(!new File("\\\\"+config.getPrimaryIpAddress()+ "c\\Images\\PPL\\Photos\\" +team.get(tournament.get(i).getPlayer().getTeamId() -1 ).getTeamName4()
										+"\\\\"+ tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
									this.status = CricketUtil.UNSUCCESSFUL;
								}
								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgPlayerImage " + "\\\\\\\\"+config.getPrimaryIpAddress()+ "c\\Images\\PPL\\Photos\\" + 
										team.get(tournament.get(i).getPlayer().getTeamId() -1 ).getTeamName4() +"\\\\"+ 
										tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + ";");
							}
			...
			for(int i = 0; i <= this_series.size() - 1 ; i++) {
				if(this_series.get(i).getPlayerId() == Playerid) {
					if(this_series.get(i).getPlayer().getTeamId() == match.getSetup().getHomeTeamId()) {
						...
						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgLogo " + logo_path + match.getSetup().getHomeTeam().getTeamBadge().toUpperCase() + 
								CricketUtil.PNG_EXTENSION + ";");
					}else {
						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgPlayerImage " + photo_path + match.getSetup().getAwayTeam().getTeamName4()
								+"\\\\"+ this_series.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + ";");
						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgLogo " + logo_path + match.getSetup().getAwayTeam().getTeamBadge().toUpperCase() + 
								CricketUtil.PNG_EXTENSION + ";");
					}
