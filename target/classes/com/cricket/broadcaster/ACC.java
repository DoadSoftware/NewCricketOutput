...
public class ACC extends Scene{
	public String broadcaster = "ACC";
	...
	public ACC(String scene_path, String which_Layer) {
...
//			return JSONArray.fromObject(cricketService.getPointers()).toString();
//		case "TEAM_FIXTURES_GRAPHICS-OPTIONS": case "TEAM_SQUAD_GRAPHICS-OPTIONS":
...
//			if(which_graphics_onscreen == "LEADERBOARD") {
...
//		case "POPULATE-FF-PLAYERPROFILEBALL": case "POPULATE-FF-DOUBLETEAMS": case "POPULATE-FF_THIS-SERIES": case "POPULATE-FF-LEADERBOARD": case "POPULATE-FF-MATCHID": 
//		case "POPULATE-FF-PLAYINGXI": case "POPULATE-LT-PARTNERSHIP": case "POPULATE-FF-LANDMARK": case "POPULATE-PREVIOUS_SUMMARY": case "POPULATE-FF-SQUAD":
...
//		case "POPULATE-FF-TEAM_SQUAD": case "POPULATE-INN_BUILDER": case "POPULATE-RICHEIS":
//		
//		//Bug
...
//			
//		//LT
//		case "POPULATE-L3-POINTERS": case "POPULATE-PHASE":
...
//		case "POPULATE-L3-GENERIC":  case "POPULATE-DLS": case "POPULATE-DLS-EQUATION": case "POPULATE-NEXT_TO_BAT":
//		   
//		case "LOAD_MANUAL_XML_SCENE": case "POPULATE-PLAYOFF":
//		 
//			
...
//				scenes.set(2, new Scene("/Default/ACC/" + valueToProcess.replace(".xml", ""),"MIDDLE_LAYER"));
...
//			case "POPULATE-L3-INFOBAR": case "POPULATE-INFOBAR-IDENT": case "POPULATE-INFOBAR_IDENT_DATA":
//				break;
...
//					return JSONObject.fromObject(this_Data).toString();
//				}
//				
//				switch (whatToProcess.toUpperCase()) {
...
//					populateLtNextToBat(print_writer, valueToProcess.split(",")[0],cricketService.getAllStats(), match, broadcaster, config);
//					break;
...
//								populateLTPlayerProfile(print_writer,valueToProcess.split(",")[0],valueToProcess.split(",")[2],valueToProcess.split(",")[3],
//										valueToProcess.split(",")[4],stats,match, broadcaster);
//							}
//						}
//					}
//					
...
//											valueToProcess.split(",")[3],valueToProcess.split(",")[4],stats,match, broadcaster, config);
//								}
//							}
//						}
//					break;
...
//					}
//					
//					populatePointsTable(print_writer, valueToProcess.split(",")[0],group_A.getLeagueTeams(),group_B.getLeagueTeams(),cricketService.getTeams(),
//							broadcaster,match);
...
//								unmarshal(new File(CricketUtil.CRICKET_DIRECTORY + CricketUtil.LEAGUE_TABLE_DIRECTORY + "GroupB.xml"));
//					}
//					populateLtPointsTable(print_writer, valueToProcess.split(",")[0],valueToProcess.split(",")[1],ltgroup_A.getLeagueTeams(),ltgroup_B.getLeagueTeams(),
//							cricketService.getTeams(),match,broadcaster);
//					break;
...
//					break;
//				case "POPULATE-PHASE":
//					populateLtPhaseByScore(print_writer, valueToProcess.split(",")[0],match, broadcaster);
//					break;
...
//		//ScoreBug
//		case "ANIMATE-IN-INFOBAR": case "ANIMATE-IN-IDENT": case "ANIMATE-SHRINK_IN": case "ANIMATE-SHRINK_OUT":
...
//				
//		//FF
//		case "ANIMATE-MINI-BOWLINGCARD": case "ANIMATE-MINI-BATTINGCARD":
...
//		case "ANIMATE-IN-SQUAD": case "ANIMATE-IN-LTPARTNERSHIP": case "ANIMATE-IN-LANDMARK": case "ANIMATE-IN-POSITION_LANDMARK": case "ANIMATE-IN-POINTSTABLE":
...
//		case "ANIMATE-IN-FF_THIS-SERIES": case "ANIMATE-IN-WORM": case "ANIMATE-IN-BATGRIFF": case "ANIMATE-IN-BALLGRIFF": case "ANIMATE-IN-FF_POINTERS":
...
//		case "ANIMATE-IN-BUG-TOSS": case "ANIMATE-IN-BUG_HIGHLIGHT": case "ANIMATE-IN-BUGPARTNERSHIP": case "ANIMATE-IN-MULTI_PARTNERSHIP":
//			
//		//LT
//		case "ANIMATE-IN-LTPOINTSTABLE": case "ANIMATE-IN-PHASE":
...
//		case "ANIMATE-OUT-POWERPLAY":  case "ANIMATE-IN-THISSERIES":  case "ANIMATE-IN-BUG_POWERPLAY": case "ANIMATE-IN-PLAYOFF": case "ANIMATE-IN-DLS": 
...
//				break;
//			
//			case "CLEAR-ALL": case "ANIMATE-IN-MANUAL_GRAPHIC": case "ANIMATE-IN-PLAYOFF":
//			case "ANIMATE-IN-PLAYERSUMMARY":
//			case "ANIMATE-IN-SCORECARD": case "ANIMATE-IN-BOWLINGCARD": case "ANIMATE-IN-PARTNERSHIP": case "ANIMATE-IN-MATCHSUMARRY": case "ANIMATE-IN-PLAYERPROFILE":
//			case "ANIMATE-IN-PLAYERPROFILEBALL": case "ANIMATE-IN-DOUBLETEAMS": case "ANIMATE-IN-FF_THIS-SERIES": case "ANIMATE-IN-MATCHID": case "ANIMATE-IN-PLAYINGXI":
//			case "ANIMATE-IN-LEADERBOARD": case "ANIMATE-IN-LANDMARK": case "ANIMATE-IN-POSITION_LANDMARK":  case "ANIMATE-IN-POINTSTABLE": case "ANIMATE-IN-MANHATTAN":
...
//			case "ANIMATE-IN-BATGRIFF": case "ANIMATE-IN-BALLGRIFF": case "ANIMATE-IN-FF_POINTERS": case "ANIMATE-IN-FIXTURES": case "ANIMATE-IN-FIXTURES_TEAM":
//			case "ANIMATE-IN-TEAM_SQUAD": case "ANIMATE-IN-INN_BUILDER": case "ANIMATE-IN-RICHEIS":
//			
//			case "ANIMATE-IN-POINTERS": case "ANIMATE-IN-PHASE":
//			case "ANIMATE-IN-HOWOUT": case "ANIMATE-IN-BATSMANSTATS":	case "ANIMATE-IN-NAMESUPER": case "ANIMATE-IN-NAMESUPER-PLAYER": case "ANIMATE-IN-PROJECTED":
...
//			case "ANIMATE-IN-COMPARISION": case "ANIMATE-IN-L3MATCHID": case "ANIMATE-IN-SQUAD": case "ANIMATE-IN-BOWLERSTATS": case "ANIMATE-IN-SPLIT": 
//			case "ANIMATE-IN-HOWOUT_QUICK": case "ANIMATE-IN-LTPARTNERSHIP": case "ANIMATE-IN-BOWLERSUMMARY": case "ANIMATE-IN-NEXT_TO_BAT": case "ANIMATE-IN-BOWLERDETAILS":
...
//			case "ANIMATE-IN-BOWLER_STYLE": case "ANIMATE-IN-HOWOUT_WITHOUT_FIELDER": case "ANIMATE-IN-THISSERIES": case "ANIMATE-IN-BATSMAN_STYLE": case "ANIMATE-IN-GENERIC": 
//			case "ANIMATE-IN-L3MATCH_PROMO": case "ANIMATE-IN-DLS": case "ANIMATE-IN-DLS-EQUATION":
...
//				break;
//			
//			case "ANIMATE-IN-LTPOINTSTABLE": case "ANIMATE-MINI-BOWLINGCARD": case "ANIMATE-MINI-BATTINGCARD":
//				if(infobar.isInfobar_on_screen() == true && which_graphics_onscreen == "SCOREBUG") {
...
//               
//               print_writer.println("-1 RENDERER*FRONT_LAYER SET_OBJECT SCENE*/Default/ACC/ScoreBug\0");
//           	
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo02" + " SET " + flag_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase()+ "\0");
...
//						} else {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo02" + " SET " + flag_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
...
//												print_writer.println("-1 RENDERER*TREE*$Main$BattingCard$Row" + row_id + "$RowOmo" + cont_name + "$WicketPlayerName*GEOM*TEXT SET " + bc.getHowOutPartOne().replace("(SUB)", "") + "  " + bc.getHowOutPartTwo().split(" ")[0] + "" + "\0");
//												print_writer.println("-1 RENDERER*TREE*$Main$BattingCard$Row" + row_id + "$RowOmo" + cont_name + "$BallPlayerName*GEOM*TEXT SET " + "" + "\0");
//											
...
//											}
//										}else {
//											print_writer.println("-1 RENDERER*TREE*$Main$BattingCard$Row" + row_id + "$RowOmo" + cont_name + "$WicketPlayerName*GEOM*TEXT SET " + bc.getHowOutText()  + "  (" + bc.getHowOutPartTwo().split(" ")[0] + " )" + "\0");
//											print_writer.println("-1 RENDERER*TREE*$Main$BattingCard$Row" + row_id + "$RowOmo" + cont_name + "$BallPlayerName*GEOM*TEXT SET " + "" + "\0");	
//										}
...
//						//print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + flag_path + inn.getBatting_team().getTeamLogo().toUpperCase() + "\0");
//	
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//	
//						if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo02" + " SET " + flag_path + 
//									match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
...
//						} else {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo02" + " SET " + flag_path + 
//									match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$BowlingCard$MaxSize$BallHeader*GEOM*TEXT SET " + 
...
//				//String commands = "";
//				int row = 1, max_Strap = 9; 
//				for(Inning inn : match.getMatch().getInning()) {
//					if (inn.getInningNumber() == whichInning) {
//						
//						if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTeamFirstName " + match.getHomeTeam().getTeamName1().toUpperCase() + ";" ;
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tSubHeader01 " + "v " + match.getAwayTeam().getTeamName1().toUpperCase() + ";" ;
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallTeamName " + match.getSetup().getHomeTeam().getTeamName1().toUpperCase() + ";");
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallSubHeader " + "v " + match.getSetup().getAwayTeam().getTeamName1().toUpperCase() + ";");
//						} else {
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTeamFirstName " + match.getAwayTeam().getTeamName1().toUpperCase() + ";" ;
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tSubHeader01 " + "v " + match.getHomeTeam().getTeamName1().toUpperCase() + ";" ;
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallTeamName " + match.getSetup().getAwayTeam().getTeamName1().toUpperCase() + ";");
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallSubHeader " + "v " + match.getSetup().getHomeTeam().getTeamName1().toUpperCase() + ";");
//						}
//						//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main$Data$Top$Logo$TeamLogo*CONTAINER SET ACTIVE 1;" ;
//						//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgTeamLogo " + flag_path + inn.getBowling_team().getTeamLogo() + CricketUtil.PNG_EXTENSION + ";" ;
//						//print_writer.println("LAYER1*EVEREST*TREEVIEW*Main$Data$Top$Logo$TeamLogo*CONTAINER SET ACTIVE 1;");
//						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgBallTeamLogo " + flag_path + inn.getBowling_team().getTeamLogo() + CricketUtil.PNG_EXTENSION + ";");
//						
//						for (BowlingCard boc : inn.getBowlingCard()) {
//							row_id = row_id + 1;
//							row = row + 1;
//	
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*"+ row + "*CONTAINER SET ACTIVE 1;" ;
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPlayerName0" + row_id + " "  + boc.getPlayer().getTicker_name().toUpperCase() + ";" ;
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row + "A " + CricketFunctions.OverBalls(boc.getOvers(), boc.getBalls()) +";" ;
//							
//							
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*"+ row + "*CONTAINER SET ACTIVE 1;");
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallPlayerName0" + row_id + " "  + boc.getPlayer().getTicker_name().toUpperCase() + ";");
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "A " + CricketFunctions.OverBalls(boc.getOvers(), boc.getBalls()) +";");
...
//								//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatHeadB " +"DOTS" +";" ;
//								//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row + "B " + boc.getDots() +";" ;
//								
//								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatHeadB " +"DOTS" +";");
//								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "B " + boc.getDots() +";");
//							}
//							else {
//								//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row + "B " + boc.getMaidens() +";" ;
//								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "B " + boc.getMaidens() +";");
//							}
//							
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row + "C " + boc.getRuns() +";" ;
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row + "D " + boc.getWickets() + ";" ;
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tStatValue" + row + "E " + boc.getEconomyRate() + ";" ;
//							
//							
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "C " + boc.getRuns() +";");
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "D " + boc.getWickets() + ";");
//							if(boc.getEconomyRate() == null) {
//								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "E " + "-" + ";");
//							}else {
//								print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallStatValue" + row + "E " + boc.getEconomyRate() + ";");
//							}
//							
//							
//						}
//						for(int j = row + 1; j <= max_Strap; j++) {
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*"+ j + "*CONTAINER SET ACTIVE 0;" ;
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main$BowlingCard_GRP$DataAll$BAtting$Bowling_Card$" + j + "*CONTAINER SET ACTIVE 0;");
//						}
//						row_id= 0 ;
...
//									//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main$DataAll$BAtting$Bowling_Card$10*CONTAINER SET ACTIVE 0;" ;
//									//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main$DataAll$BAtting$Bowling_Card$11*CONTAINER SET ACTIVE 0;" ;
//									print_writer.println("LAYER1*EVEREST*TREEVIEW*Main$BowlingCard_GRP$DataAll$BAtting$Bowling_Card$FOWGRP*CONTAINER SET ACTIVE 0;");
...
//											//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main$DataAll$BAtting$Bowling_Card$10*CONTAINER SET ACTIVE 1;" ;
//											//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main$DataAll$BAtting$Bowling_Card$11*CONTAINER SET ACTIVE 1;" ;
//											//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET vWKTS "+ fow.getFowNumber() + ";" ;
//											//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tWKTRun0" + row_id + " "  + fow.getFowRuns() + ";" ;
//											print_writer.println("LAYER1*EVEREST*TREEVIEW*Main$BowlingCard_GRP$DataAll$BAtting$Bowling_Card$FOWGRP*CONTAINER SET ACTIVE 1;");
...
//							}
//						}
//						//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tOvers " + CricketFunctions.OverBalls(inn.getTotalOvers(), inn.getTotalBalls()) + ";" ;
//						//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tExtras " + inn.getTotalExtras() + ";" ;
//						//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tRunRate "+ inn.getRunRate() + ";" ;
//						
//						
//						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallOvers " + CricketFunctions.OverBalls(inn.getTotalOvers(), inn.getTotalBalls()) + ";");
//						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallExtras " + inn.getTotalExtras() + ";");
//						print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tRunRate "+ inn.getRunRate() + ";");
//						if(inn.getTotalWickets() >= 10) {
//							
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tScore " + inn.getTotalRuns() + ";" ;
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallScore " + inn.getTotalRuns() + ";");
//						}
//						else {
//							//commands = commands + "LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tScore " + inn.getTotalRuns() + slashOrDash + String.valueOf(inn.getTotalWickets()) + ";" ;
//							print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBallScore " + inn.getTotalRuns() + slashOrDash + String.valueOf(inn.getTotalWickets()) + ";");
//						}
//					}
//				}
...
//				print_writer.println("LAYER1*EVEREST*STAGE*DIRECTOR*In SHOW 136.0;");
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "" + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main$All$TopPart$LogoMotion*ACTIVE SET 0 \0");
//						//print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + flag_path + inn.getTeamLogo().getTeamName4().toUpperCase() + "\0");
//	
...
//						
//						if (inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + flag_path + 
//									match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
//						} else {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + flag_path + 
...
//											}else if(CricketFunctions.getRequiredRuns(match) <= 0 || CricketFunctions.getRequiredBalls(match) <= 0 || 
...
//										print_writer.println("-1 RENDERER*TREE*$Main$All$PartnershipAll$Data$BatDataGrp$Row" + row_id  + 
//												"$RowAnimation$RowOmo$LeftPlayerName$LeftPlayerNameText*GEOM*TEXT SET " + 
...
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$BatTeamLogo*TEXTURE*IMAGE SET " + logo_path + "ACC_Logo.png" +" \0");
//	
//	
...
//						teamname_logo  = match.getSetup().getHomeTeam().getTeamLogo().toUpperCase();
//					} else {
//						teamname = match.getSetup().getAwayTeam().getTeamName1();
//						teamname_logo = match.getSetup().getAwayTeam().getTeamLogo().toUpperCase();
//					}
//					
//					
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumTeamBadge" + i + " SET " + flag_path + teamname_logo + "\0");
...
//									+ CricketFunctions.generateMatchSummaryStatus(whichInning, match, CricketUtil.FULL, broadcaster).toUpperCase() + " \0");
...
//			
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupHeader1" + " SET " + "GROUP A" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupHeader2" + " SET " + "GROUP B" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupB_TeamBadge1" + " SET " + flag_path + "IND" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupB_TeamName1" + " SET " + "INDIA A" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupB_TeamBadge2" + " SET " + flag_path + "UAE" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupB_TeamName2" + " SET " + "UAE A" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupB_TeamBadge3" + " SET " + flag_path + "NEP" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupB_TeamName3" + " SET " + "NEPAL" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupB_TeamBadge4" + " SET " + flag_path + "PAK" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupB_TeamName4" + " SET " + "PAKISTAN A" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupA_TeamBadge1" + " SET " + flag_path + "SL" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupA_TeamName1" + " SET " + "SRI LANKA A" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupA_TeamBadge2" + " SET " + flag_path + "BAN" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupA_TeamName2" + " SET " + "BANGLADESH A" + "\0");
//			
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupA_TeamBadge3" + " SET " + flag_path + "AFG" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupA_TeamName3" + " SET " + "AFGHANISTAN A" + "\0");
//	
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgGroupA_TeamBadge4" + " SET " + flag_path + "OMA" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tGroupA_TeamName4" + " SET " + "OMAN A" + "\0");
//			
...
//					}else {
//						if(fixtures.get(i).getMatchfilename().contains("_")) {
//							match_name = fixtures.get(i).getMatchfilename().replace("_", " ").toUpperCase();
//						}else {
...
//							fixtures.get(i).getGmtTime() + " ON " + newDate + dateSuffix[Integer.valueOf(newDate)] + " JULY FROM " + fixtures.get(i).getVenue() + "\0");
//					}
//				}
//			}
//			
...
//			
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge02" + " SET " + flag_path + 
//					teams.get(teamid - 1).getTeamLogo() + "\0");
...
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo1" + " SET " + match.getSetup().getHomeTeam().getTeamName2().toUpperCase() + "\0");
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo3" + " SET " + 
//							" WON TOSS & CHOSE TO " + match.getSetup().getTossWinningDecision() + "\0");
//				}else {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo1" + " SET " + match.getSetup().getAwayTeam().getTeamName2().toUpperCase() + "\0");
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo3" + " SET " + 
//							" WON TOSS & CHOSE TO " + match.getSetup().getTossWinningDecision() + "\0");
//				}
//				
...
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo2" + " SET " + "" + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo3" + " SET " + 
//					match.getMatch().getInning().get(whichInning-1).getBatting_team().getTeamName4() + "\0");
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo4" + " SET " + "" + "\0");
//			
//			
...
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo5" + " SET " + bug.getText4() + "\0");
...
//					}else {
//						if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +Pt.getTeam()
//								+ "\\\\" + Pt.getPlayer() + CricketUtil.PNG_EXTENSION).exists()) {
...
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "003-Image" + " SET " + flag_path + Pt.getTeam() + "\0");
//				}else {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "003-Image" + " SET " + logo_path + "ACC_Logo" + "\0");
//				}
//				
//				
//
...
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path 
//														+ inn.getBatting_team().getTeamLogo().toUpperCase() + "\0");								
//	
...
//	
//									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path 
//											+ inn.getBowling_team().getTeamLogo().toUpperCase() + "\0");
//									
//									if(match.getSetup().getMatchType().toUpperCase().equalsIgnoreCase(CricketUtil.DT20) || match.getSetup().getMatchType().toUpperCase().equalsIgnoreCase(CricketUtil.IT20)) {
//										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead2" + " SET " + "DOTS" + CricketFunctions.Plural(boc.getDots()).toUpperCase() + "\0");
//										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatValue2" + " SET " + boc.getDots() + "\0");
//									}else {
//										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead2" + " SET " + "MAIDEN" + CricketFunctions.Plural(boc.getMaidens()).toUpperCase() + "\0");
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path 
//								+ match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
...
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path 
//									+ match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");							
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET " + hos.getFull_name().toUpperCase() + "\0");
//						}
//					}
//				}
//				else {
...
//						}
//					}
//					for(Player aos : match.getSetup().getAwaySquad()) {
//						if(playerId == aos.getPlayerId()) {
//							Home_or_Away = match.getSetup().getAwayTeam().getTeamName1().toUpperCase();
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path 
//									+ match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET " + " " + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET " + aos.getFull_name().toUpperCase() + "\0");
//						}
//					}
//				}
//				
...
//	}
//	
//	public void populatePlayerProfile(PrintWriter print_writer,String viz_scene, int playerId,String TypeofProfile,String Profile,String Value,Statistics stats, MatchAllData match, String session_selected_broadcaster, Configuration config) throws InterruptedException 
//	{
//		
//		double strike_rate = 0,avg=0 , economy_rate=0;
...
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSponsor" + " SET " + logo_path  + "" + "\0");
//	
...
//							match.getSetup().getHomeTeam().getTeamLogo() + "\\\\" + plyr.getPhoto() + ".png" + "\0");
//				}else {
//					if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getHomeTeam().getTeamLogo()
//							+ "\\\\" + plyr.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//						this.status = CricketUtil.UNSUCCESSFUL;
//					}
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+ "\\c\\Images\\ACC\\Photos\\"+
//					match.getSetup().getHomeTeam().getTeamLogo() + "\\\\" + plyr.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//				}
//			}
//			else {
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path 
...
//				if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + photo_path + 
//							match.getSetup().getAwayTeam().getTeamLogo() + "\\\\" + plyr.getPhoto() + ".png" + "\0");
//				}else {
//					if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getAwayTeam().getTeamLogo()
//							+ "\\\\" + plyr.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//						this.status = CricketUtil.UNSUCCESSFUL;
//					}
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" + 
//							match.getSetup().getAwayTeam().getTeamLogo() + "\\\\" + plyr.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//				}
//				
//				
//	
...
//			}else if(stats.getStats_type().getStats_short_name().toUpperCase().equalsIgnoreCase("IPL2023")) {
//				print_writer.println("-1 RENDERER*TREE*$Main$All$BottomInfo$Bottom_Info*GEOM*TEXT SET " + "IPL 2023" + "\0");
...
//		
//	}
//	public void populateLTPlayerProfile(PrintWriter print_writer,String viz_scene,String Profile,String Value,String TypeofProfile,Statistics stats, MatchAllData match, String session_selected_broadcaster) throws InterruptedException 
//	{
//		double strike_rate = 0,avg = 0 , economy_rate=0;
//		int dismissal_count=0;
//		switch (session_selected_broadcaster.toUpperCase()) {
...
//				}else if(stats.getStats_type().getStats_short_name().toUpperCase().equalsIgnoreCase("IPL2023")) {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tSubHead" + " SET " + "IPL 2023" + "\0");
//				}else if(stats.getStats_type().getStats_short_name().toUpperCase().equalsIgnoreCase("DT20")) {
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSponsor" + " SET " + logo_path 
//								+ "ACC_Logo" + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge1" + " SET " + flag_path 
//								+ match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
...
//								"IMAGEDefault/ACC/Logos/" + "ACC_Logo" + ".png" + "\0");*/
//													
//						for(Player hs : match.getSetup().getHomeSquad()) {
//							row_id = row_id + 1;
//							omo = 0;
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge2" + " SET " + flag_path 
//								+ match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
...
//								flag_path + match.getAwayTeam().getTeamName4() + ".png" + "\0");*/
//						
//						for(Player as : match.getSetup().getAwaySquad()) {
//							row_id = row_id + 1;
//							omo = 0;
...
//				flag_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
//		print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgIdentTeamLogo2" + " SET " + 
//				flag_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
//		
...
//								+ " NEED " + CricketFunctions.getTargetRuns(match) + " RUNS TO WIN FROM " + match.getSetup().getMaxOvers()*6 + " BALLS" + "\0");
//				}else {
//					if(Double.valueOf(match.getSetup().getTargetOvers()) == 1) {
//						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$Ident$InfoGrp$Equation*GEOM*TEXT SET " + match.getMatch().getInning().get(1).getBatting_team().getTeamName1().toUpperCase() 
//								+ " NEED " + CricketFunctions.getTargetRuns(match) + " RUNS TO WIN FROM " + Double.valueOf(match.getSetup().getTargetOvers())*6 + " BALLS" + "\0");
//					}
//					if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("VJD")) {
//						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$Ident$InfoGrp$Equation*GEOM*TEXT SET " + match.getMatch().getInning().get(1).getBatting_team().getTeamName1().toUpperCase() 
//								+ " NEED " + CricketFunctions.getTargetRuns(match) + " RUNS TO WIN FROM " + Double.valueOf(match.getSetup().getTargetOvers())*6 + " BALLS (VJD)" + "\0");
//					}else if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("DLS")) {
//						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$Ident$InfoGrp$Equation*GEOM*TEXT SET " + match.getMatch().getInning().get(1).getBatting_team().getTeamName1().toUpperCase() 
//								+ " NEED " + CricketFunctions.getTargetRuns(match) + " RUNS TO WIN FROM " + Double.valueOf(match.getSetup().getTargetOvers())*6 + " BALLS (DLS)" + "\0");
//					}
//				}
//				
//				ident_on_screen = true;
...
//						if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("VJD")) {
//							print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$Ident$InfoGrp$Equation*GEOM*TEXT SET " + 
//									CricketFunctions.generateMatchSummaryStatus(2, match, CricketUtil.FULL, broadcaster).toUpperCase() + " (VJD)" + " \0");
//						}
//					}
//				}
//				ident_on_screen = true;
...
//							flag_path + inn.getBatting_team().getTeamLogo().toUpperCase() + "\0");
//						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBatTeamLogo" + " SET " + 
//							flag_path + inn.getBatting_team().getTeamLogo().toUpperCase() + "\0");
//						print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgBallTeamLogo" + " SET " + 
//							flag_path + inn.getBowling_team().getTeamLogo().toUpperCase() + "\0");
//					}
...
//								 CricketFunctions.processPowerPlay(CricketUtil.MINI,match) + "\0");
//			         }
//				}else {
//					if(infobar.isPowerplay_on_screen() == true) {
...
//						break;
//					case"FREE_TEXT": case "DLS_TARGET": case "DLS_EQUATION":
...
//						CricketFunctions.generateRunRate(CricketFunctions.getRequiredRuns(match), 0, CricketFunctions.getRequiredBalls(match), 2,match) + "\0");
...
//							if (CricketFunctions.getRequiredRuns(match) <= 0 || CricketFunctions.getRequiredBalls(match) <= 0 || CricketFunctions.getWicketsLeft(match,2) <= 0) {
...
//											print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedRun" + " SET " + 
//													CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + "\0");
//											print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedBall" + " SET " + 
//													CricketFunctions.OverBalls(0,CricketFunctions.getRequiredBalls(match)) + " OVERS" + "\0");
//										}else {
//											print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedHead" + " SET " + "NEED " + "\0");
//											print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedSubHead" + " SET " + " TO WIN FROM " + "\0");
//											print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedRun" + " SET " + 
//													CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + "\0");
//											print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedBall" + " SET " + 
//													CricketFunctions.getRequiredBalls(match) + " BALL" + CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + "\0");
//										}
//										
//									}
//								}else {
...
//															CricketFunctions.getRequiredRuns(match) + "RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedBall" + " SET " + 
//															CricketFunctions.OverBalls(0,CricketFunctions.getRequiredBalls(match)) + " OVERS" + " (VJD)" + "\0");											
//												}else {
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedHead" + " SET " + "NEED " + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedSubHead" + " SET " + " TO WIN FROM " + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedRun" + " SET " + 
...
//															CricketFunctions.getRequiredBalls(match) + " BALL" + CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + " (VJD)" + "\0");
//												}
//											}
//											else if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("DLS")) {
//												if (CricketFunctions.getRequiredBalls(match) >= 100) {
...
//															CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedBall" + " SET " + 
//															CricketFunctions.OverBalls(0,CricketFunctions.getRequiredBalls(match)) + " OVERS" + " (DLS)" + "\0");
//												}else {
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedHead" + " SET " + "NEED " + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedSubHead" + " SET " + " TO WIN FROM " + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedRun" + " SET " + 
//															CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + "\0");
//													print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNeedBall" + " SET " + 
//															CricketFunctions.getRequiredBalls(match) + " BALL" + CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + " (DLS)" + "\0");
//												}
//											}
//											else {
//												if (CricketFunctions.getRequiredBalls(match) >= 100) {
...
//							+ "BALL"+ CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + "\0");
...
//							+ "RUN"+ CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + "\0");
//					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tRuns" + " SET " + CricketFunctions.getRequiredRuns(match) + "\0");
//					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tBalls" + " SET " + CricketFunctions.getRequiredBalls(match) + "\0");
//				}else if (CricketFunctions.getRequiredRuns(match) <= 0 || CricketFunctions.getRequiredBalls(match) <= 0 || CricketFunctions.getWicketsLeft(match,2) <= 0) {
...
//							team = inn.getBatting_team().getTeamName4().toUpperCase();
...
//									+ "*GEOM*TEXT SET " + "DLS TARGET SCORE AFTER " + balls + " OVERS: " + (Integer.valueOf(this_dls.get(i).getWkts_down()) + 1) + "\0");
//							break;
//						case "DLS_EQUATION":
...
//					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$ScoreBugAll$All$AllSections$Section3$TargetAll$TargetScoreGrp$Score*GEOM*TEXT SET " + CricketFunctions.getTargetRuns(match) + " (" + match.getSetup().getTargetType().toUpperCase() + ")" + "\0");
//				}else {
//					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$Main$ScoreBugAll$All$AllSections$Section3$TargetAll$TargetScoreGrp$Score*GEOM*TEXT SET " + CricketFunctions.getTargetRuns(match) + "\0");
//				}
//				if(is_this_updating == false) {
...
//				System.out.println("ERROR: populateScorecard -> Scorecard's inning is null");
//			} else {
//				String match_name="",newDate = "",Date = "";
//				
//				String[] dateSuffix = {
//						"th", "st", "nd", "rd", "th", "th", "th", "th", "th", "th",
//						
...
//				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$AllTeamBadges$T10Logo*TEXTURE*IMAGE SET "+ logo_path + "ACC_Logo" + " \0");
//				
//				for(Team TM : team) {
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + " SET " + flag_path + TM.getTeamLogo().toUpperCase() + "\0");
//					}
...
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + " SET " + flag_path + TM.getTeamLogo().toUpperCase() + "\0");
//					}
//				}
//				
//				if(fix.get(match_number-1).getMatchnumber() < 10) {
//					match_name = "MATCH " + fix.get(match_number-1).getMatchnumber();
//				}else {
//					if(fix.get(match_number-1).getMatchfilename().contains("_")) {
//						match_name = fix.get(match_number-1).getMatchfilename().replace("_", " ").toUpperCase();
//					}else {
...
//										dateSuffix[Integer.valueOf(newDate)] + " JULY" + "\0");
//							}
//						}
//					}
//				}
...
//						break;
//					}else {
//						print_writer.println("-1 RENDERER*TREE*$Main$All$noname$Info*GEOM*TEXT SET "+ "LIVE AT " + fix.get(match_number-1).getGmtTime() 
...
//				for(Team TM : team) {
//					if(fix.get(match_number - 1).getHometeamid() == TM.getTeamId()) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path + TM.getTeamLogo().toUpperCase() + "\0");
//	
...
//					}
//					if(fix.get(match_number - 1).getAwayteamid() == TM.getTeamId()) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + flag_path + TM.getTeamLogo().toUpperCase() + "\0");
//	
...
//						+ " - LIVE AT " + fix.get(match_number - 1).getGmtTime() + " - " + "TOMORROW" + "\0");
//				}else {
//					cal.add(Calendar.DATE, -1);
//					Date =  new SimpleDateFormat("dd-MM-yyyy").format(cal.getTime());
//					if(fix.get(match_number-1).getDate().equalsIgnoreCase(Date)) {
...
//						}
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "MATCH " + fix.get(match_number - 1).getMatchnumber()
//								+ " - LIVE AT " + fix.get(match_number - 1).getGmtTime() + " - " + newDate + dateSuffix[Integer.valueOf(newDate)] + " JULY" + "\0");
//
//					}
//				}
//				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.png In 3.500 \0");
...
//				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$Shriram_Logo*ACTIVE SET 0 \0");
//	
//				print_writer.println("-1 RENDERER*TREE*$Main$All$noname$AllTeamBadges$T10Logo*TEXTURE*IMAGE SET "+ "C:\\\\Images\\\\ACC\\\\LOGOS\\\\ACC_Logo.png" + " \0");
...
//	
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + " SET " + flag_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + " SET " + flag_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
//	
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + " SET " + match.getSetup().getMatchIdent() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main$All$MatchId*GEOM*TEXT SET "+ "" + " \0");
...
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path 
//						+ match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamLogo" + " SET " + flag_path 
//						+ match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
//				
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHomeTeamFirstName" + " SET " + "" + "\0");
...
//				if(TeamId == match.getSetup().getHomeTeamId()) {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + "ACC_Logo" + " \0");
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + flag_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + " \0");
...
//									match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + hs.getPhoto() + ".png" + "\0");
//						}else {
//							if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getHomeTeam().getTeamLogo().toUpperCase()
...
//				else {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + "ACC_Logo" + " \0");
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + flag_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + " \0");
...
//						if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_id + " SET " + photo_path + 
//									match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + as.getPhoto() + ".png" + "\0");
//						}else {
//							if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getAwayTeam().getTeamLogo().toUpperCase()
...
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET "+ " " + " \0");
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path + inn.getBatting_team().getTeamLogo().toUpperCase() + "\0");
//	
...
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Stats$StatAll1$Runs*GEOM*TEXT SET " + CricketFunctions.getTargetRuns(match) + "\0");
...
//						for(BattingCard bc : inn.getBattingCard()) {
//							if (inn.getInningNumber() == whichInning) {
//								//print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgTeamLogo " + flag_path + inn.getBatting_team().getTeamLogo() + CricketUtil.PNG_EXTENSION + ";");
//								if(PlayerId == bc.getPlayerId()) {
//									print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$SubHead*GEOM*TEXT SET " + " " + "\0");								
//									print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$SubHead*GEOM*TEXT SET " + " " + "\0");								
//	
...
//										print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgTeamLogo " + flag_path + match.getHomeTeam().getTeamLogo() + CricketUtil.PNG_EXTENSION + ";");
//									} else {
//										print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgTeamLogo " + flag_path + match.getAwayTeam().getTeamLogo() + CricketUtil.PNG_EXTENSION + ";");
//									}*/
...
//								
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path + inn.getBowling_team().getTeamLogo().toUpperCase() + "\0");
...
//		
//	}
//	public void populateLtNextToBat(PrintWriter print_writer, String viz_scene,List<Statistics> stats, MatchAllData match, String session_selected_broadcaster, Configuration config) throws InterruptedException 
//	{
//		switch (session_selected_broadcaster.toUpperCase()) {
//		case "ACC":
//			if (match == null) {
...
//								flag_path + inn.getBatting_team().getTeamLogo() + "\0");
//		
...
//									if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_id + " SET " + photo_path + 
//												inn.getBatting_team().getTeamLogo() + "\\\\" + inn.getBattingCard().get(b-1).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//									}else {
//										if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +inn.getBatting_team().getTeamLogo()
...
//					if (inn.getInningNumber() == whichInning) {
//						if (inn.getBowlingTeamId() == match.getSetup().getHomeTeamId()) {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\0");
...
//						} else {
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + flag_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
...
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$ROW1$All_StatsVal$StatValues_GRP$StatValue5*ACTIVE SET 0" + " \0");
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$ROW1$All_StatsVal$StatValues_GRP$StatValue6*ACTIVE SET 0" + " \0");
//						
//						
...
//								print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$ROW1$All_StatsVal$StatValues_GRP$StatValue" + row_id + 
//										"$StatValue1B*GEOM*TEXT SET "+ Splitballs[i] + "\0");
//	
//					    	}
//					    	/*else {
...
//								inn.getBowling_team().getTeamName1().toUpperCase() + "\0");
...
//								inn.getBowling_team().getTeamName1().toUpperCase() + " TOTAL " + match.getMatch().getInning().get(0).getTotalRuns() + "-" + match.getMatch().getInning().get(0).getTotalWickets() + "\0");
//						
//					}
//				}
//				print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.500 \0");
...
//		}
//	}
//	public void populateLTPartnership(PrintWriter print_writer, String viz_scene, MatchAllData match, String session_selected_broadcaster, Configuration config) 
//	{
//		if (match == null) {
//			System.out.println("ERROR: populateScorecard -> Match is null"); // DJ change all 'this.status' to 'system printout'
//		} else if (match.getMatch().getInning() == null) {
...
//						teamname = match.getSetup().getHomeTeam().getTeamLogo().toUpperCase();
//					}
//					else {
//						teamname = match.getSetup().getAwayTeam().getTeamLogo().toUpperCase();
//					}
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo02" + " SET " + flag_path + teamname + "\0");
//	
//					for (Player hs : match.getSetup().getHomeSquad()) {
//						if(hs.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterNo()) {
...
//										teamname + "\\\\" + hs.getPhoto() + ".png" + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +teamname
//										+ "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//									this.status = CricketUtil.UNSUCCESSFUL;
//								}
...
//					
//					for (Player hos : match.getSetup().getHomeOtherSquad()) {
//						if(hos.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterNo()) {
//							Left_Batsman = hos.getFull_name().toUpperCase();
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + photo_path + 
//										teamname + "\\\\" + hos.getPhoto() + ".png" + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +teamname
//										+ "\\\\" + hos.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//									this.status = CricketUtil.UNSUCCESSFUL;
//								}
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
//										teamname + "\\\\" + hos.getPhoto() + ".png" + "\0");
//							}
//						}
//						if(hos.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getSecondBatterNo()) {
//							Right_Batsman = hos.getFull_name().toUpperCase();
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage2" + " SET " + photo_path + 
//										teamname + "\\\\" + hos.getPhoto() + ".png" + "\0");
//							}else {
...
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + photo_path + 
//										teamname + "\\\\" + as.getPhoto() + ".png" + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path +teamname
//										+ "\\\\" + as.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//									this.status = CricketUtil.UNSUCCESSFUL;
//								}
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+local_photo_path + 
...
//					
//					for (Player aos : match.getSetup().getAwayOtherSquad()) {
//						if(aos.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getFirstBatterNo()) {
//							Left_Batsman = aos.getFull_name().toUpperCase();
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + photo_path + 
//										teamname + "\\\\" + aos.getPhoto() + ".png" + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +teamname
//										+ "\\\\" + aos.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//									this.status = CricketUtil.UNSUCCESSFUL;
//								}
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage1" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
//										teamname + "\\\\" + aos.getPhoto() + ".png" + "\0");
//							}
//						}
//						if(aos.getPlayerId() == inn.getPartnerships().get(inn.getPartnerships().size() - 1).getSecondBatterNo()) {
//							Right_Batsman = aos.getFull_name().toUpperCase();
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage2" + " SET " + photo_path + 
//										teamname + "\\\\" + aos.getPhoto() + ".png" + "\0");
//							}else {
...
//			MatchAllData match, String session_selected_broadcaster, Configuration config) 
//	{
//		if (match == null) {
//			System.out.println("ERROR: populateScorecard -> Match is null"); // DJ change all 'this.status' to 'system printout'
//		} else if (match.getMatch().getInning() == null) {
...
//										photo_path + team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\\\\" + 
//											tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase()
//										+ "\\\\" + tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//									this.status = CricketUtil.UNSUCCESSFUL;
//								}
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_no + " SET " + 
//										"\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\\\\" + 
//											tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//							}	
//							
//							
...
//								}
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + row_no + " SET " + 
//										"\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" + team.get(tournament.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\\\\" + 
//											tournament.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//							}
//							
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayerName" + row_no + " SET " + 
...
//													+ photo_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION + "\0");
//										}else {
//											if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getHomeTeam().getTeamLogo().toUpperCase()
//													+ "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION).exists()) {
//												this.status = CricketUtil.UNSUCCESSFUL;
//											}
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ "\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION + "\0");
//										}
//									}
//									else {
//										print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path 
...
//										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ photo_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION + "\0");
//										}else {
//											if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase()
//													+ "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION).exists()) {
//												this.status = CricketUtil.UNSUCCESSFUL;
//											}
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ "\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path +  match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + bc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION + "\0");
//										}
//										
//									
//									}
...
//										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ photo_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + "\0");
//										}else {
//											if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getHomeTeam().getTeamLogo().toUpperCase()
//													+ "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION).exists()) {
//												this.status = CricketUtil.UNSUCCESSFUL;
//											}
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ "\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + "\0");
//										}
//										
//										
//									}
...
//										if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ photo_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + "\0");
//										}else {
//											if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getAwayTeam().getTeamLogo().toUpperCase()
//													+ "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + CricketUtil.PNG_EXTENSION).exists()) {
//												this.status = CricketUtil.UNSUCCESSFUL;
//											}
//											print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//													+ "\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + boc.getPlayer().getFirstname().toUpperCase() + "\0");
//										}
//										
//										
//									}
...
//				for(Inning inn : match.getMatch().getInning()) {
//					if (inn.getInningNumber() == whichInning) {
//						print_writer.println("-1 RENDERER*TREE*$Main$All$text$Row1$RowAnimation$noname$StatValue*GEOM*TEXT SET "+ (inn.getTotalWickets()+2) + " \0");
//						
//						for(BattingCard bc : inn.getBattingCard()) {
//							if(playerId == bc.getPlayerId()) {
//								
//								print_writer.println("-1 RENDERER*TREE*$Main$All$MaxSize$PlayerName*GEOM*TEXT SET "+ bc.getPlayer().getTicker_name().toUpperCase() + " \0");
//								
//								if(inn.getBattingTeamId() == match.getSetup().getHomeTeamId()) {
//									print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path 
//												+ match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\0");
...
//											if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//												print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//														+ photo_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//											}else {
//												if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getHomeTeam().getTeamLogo().toUpperCase()
//														+ "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//													this.status = CricketUtil.UNSUCCESSFUL;
//												}
//												print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//														+ "\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + match.getSetup().getHomeTeam().getTeamLogo().toUpperCase() + "\\\\" + hs.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//											}
//										}
//									}
//								}
...
//											if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//												print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//														+ photo_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + as.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//											}else {
//												if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getAwayTeam().getTeamLogo().toUpperCase()
//														+ "\\\\" + as.getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//													this.status = CricketUtil.UNSUCCESSFUL;
//												}
//												print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " 
//														+ "\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + match.getSetup().getAwayTeam().getTeamLogo().toUpperCase() + "\\\\" + as.getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//											}
//										}
//									}
//								}
...
//				for(Inning inn : match.getMatch().getInning()) {
//					if(inn.getInningNumber() == 2 && inn.getIsCurrentInning().equalsIgnoreCase("YES")) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path + inn.getBatting_team().getTeamLogo().toUpperCase() + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Name$PlayerName*GEOM*TEXT SET "+ inn.getBatting_team().getTeamName1().toUpperCase() + " \0");
//						
//						if(match.getSetup().getTargetOvers() == null || match.getSetup().getTargetOvers().trim().isEmpty() && match.getSetup().getTargetRuns() == 0) {
//							if(CricketFunctions.getRequiredRuns(match) == 0) {
...
//											+ " NEED " + CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + 
//											" TO WIN FROM "+  CricketFunctions.OverBalls(0,CricketFunctions.getRequiredBalls(match)) + " OVERS" + " \0");
//								}else {
//									print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Info$PlayerName*GEOM*TEXT SET "
//											+ " NEED " + CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + 
//											" TO WIN FROM "+ CricketFunctions.getRequiredBalls(match) + " BALL" + CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + " \0");
//								}
//								
//							}
//						}else {
...
//											print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Info$PlayerName*GEOM*TEXT SET "
//													+ " NEED " + CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + 
//													" TO WIN FROM "+  CricketFunctions.OverBalls(0,CricketFunctions.getRequiredBalls(match)) + " OVERS" + " (VJD)" + " \0");											
//										}else {
//											print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Info$PlayerName*GEOM*TEXT SET "
//													+ " NEED " + CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + 
//													" TO WIN FROM "+ CricketFunctions.getRequiredBalls(match) + " BALL" + CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + " (VJD)" + " \0");
//										}
//									}
//									else if(match.getSetup().getTargetType().toUpperCase().equalsIgnoreCase("DLS")) {
//										if (CricketFunctions.getRequiredBalls(match) >= 100) {
//											print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Info$PlayerName*GEOM*TEXT SET "
//													+ " NEED " + CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + 
//													" TO WIN FROM "+  CricketFunctions.OverBalls(0,CricketFunctions.getRequiredBalls(match)) + " OVERS" + " (DLS)" + " \0");
//										}else {
//											print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Info$PlayerName*GEOM*TEXT SET "
//													+ " NEED " + CricketFunctions.getRequiredRuns(match) + " RUN" + CricketFunctions.Plural(CricketFunctions.getRequiredRuns(match)).toUpperCase() + 
//													" TO WIN FROM "+ CricketFunctions.getRequiredBalls(match) + " BALL" + CricketFunctions.Plural(CricketFunctions.getRequiredBalls(match)).toUpperCase() + " (DLS)" + " \0");
//										}
//									}
//									else {
//										if (CricketFunctions.getRequiredBalls(match) >= 100) {
...
//		
//	}
//	public void populatePointsTable(PrintWriter print_writer,String viz_sence_path,List<LeagueTeam> grp_A_point_table,List<LeagueTeam> grp_B_point_table, 
//			List<Team> teams,String session_selected_broadcaster,MatchAllData match) throws InterruptedException 
//	{
//		switch (session_selected_broadcaster.toUpperCase()) {
//		case "ACC":
//			int row_id=0,omo_num=0;
...
//			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPointsLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//	
//			for(int i = 0; i <= grp_A_point_table.size() - 1 ; i++) {
//				row_id = row_id + 1;
//				if(match.getSetup().getHomeTeam().getTeamName1().toUpperCase().equalsIgnoreCase(grp_A_point_table.get(i).getTeamName().toUpperCase())  
//						|| match.getSetup().getHomeTeam().getTeamName4().toUpperCase().equalsIgnoreCase(grp_A_point_table.get(i).getTeamName().toUpperCase()) 
//						|| match.getSetup().getAwayTeam().getTeamName1().toUpperCase().equalsIgnoreCase(grp_A_point_table.get(i).getTeamName().toUpperCase())
//						|| match.getSetup().getAwayTeam().getTeamName4().toUpperCase().equalsIgnoreCase(grp_A_point_table.get(i).getTeamName().toUpperCase())) {
//					omo_num = 1;
//				}else {
//					omo_num = 0;
//				}
...
//					if(team_logo.getTeamName1().equalsIgnoreCase(grp_A_point_table.get(i).getTeamName())) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPointsTeamBadge" + row_id + " SET " + flag_path +
//								team_logo.getTeamLogo() + "\0");
//					}
//				}
//				
//				print_writer.println("-1 RENDERER*TREE*$Main$All$PointsTable$DataAll$$RowAll$Table$Row" + row_id + "$RowAni$Highlight*FUNCTION*Omo*vis_con SET " 
//						+ omo_num + " \0");
...
//				}
//
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPointsTeam" + row_id + " SET " + grp_A_point_table.get(i).getTeamName().toUpperCase() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayedValue" + row_id + " SET " + grp_A_point_table.get(i).getPlayed() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tWonValue" + row_id + " SET " + grp_A_point_table.get(i).getWon() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tLostValue" + row_id + " SET " + grp_A_point_table.get(i).getLost() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNRValue" + row_id + " SET " + grp_A_point_table.get(i).getNoResult() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPointsValue" + row_id + " SET " + grp_A_point_table.get(i).getPoints() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNRRValue" + row_id + " SET " + df.format(grp_A_point_table.get(i).getNetRunRate()) + "\0");
//	
//			}
//			for(int i = 0; i <= grp_B_point_table.size() - 1 ; i++) {
//				row_id = row_id + 1;
//				if(match.getSetup().getHomeTeam().getTeamName1().toUpperCase().equalsIgnoreCase(grp_B_point_table.get(i).getTeamName().toUpperCase())  
//						|| match.getSetup().getHomeTeam().getTeamName4().toUpperCase().equalsIgnoreCase(grp_B_point_table.get(i).getTeamName().toUpperCase()) 
//						|| match.getSetup().getAwayTeam().getTeamName1().toUpperCase().equalsIgnoreCase(grp_B_point_table.get(i).getTeamName().toUpperCase())
//						|| match.getSetup().getAwayTeam().getTeamName4().toUpperCase().equalsIgnoreCase(grp_B_point_table.get(i).getTeamName().toUpperCase())) {
//					omo_num = 1;
//				}else {
//					omo_num = 0;
//				}
//				
//				for(Team team_logo : teams) {
//					if(team_logo.getTeamName1().equalsIgnoreCase(grp_B_point_table.get(i).getTeamName())) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPointsTeamBadge" + row_id + " SET " + flag_path +
//								team_logo.getTeamLogo() + "\0");
//					}
//				}
...
//				}
//
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPointsTeam" + row_id + " SET " + grp_B_point_table.get(i).getTeamName().toUpperCase() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPlayedValue" + row_id + " SET " + grp_B_point_table.get(i).getPlayed() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tWonValue" + row_id + " SET " + grp_B_point_table.get(i).getWon() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tLostValue" + row_id + " SET " + grp_B_point_table.get(i).getLost() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNRValue" + row_id + " SET " + grp_B_point_table.get(i).getNoResult() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tPointsValue" + row_id + " SET " + grp_B_point_table.get(i).getPoints() + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tNRRValue" + row_id + " SET " + df.format(grp_B_point_table.get(i).getNetRunRate()) + "\0");
//	
//			}
...
//	{
//		int row_id=0;
//		print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tHeader" + " SET " + "STANDINGS - GROUP " + grp.toUpperCase() + "\0");
//		print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Row0$RowAni$OversHead*GEOM*TEXT SET "+ "" + " \0");
//		if(grp.equalsIgnoreCase("A")) {
//			for(int i = 0; i <= grp_A_point_table.size()-1; i++) {
//				row_id = row_id + 1;
//				//System.out.println(point_table.size());
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row1$RowAni$Data$BowlerName*GEOM*TEXT SET "+ 
//						grp_A_point_table.get(0).getTeamName().toUpperCase() + " \0");
//				if(grp_A_point_table.get(i).getQualifiedStatus().trim().equalsIgnoreCase("")) {
...
//						grp_A_point_table.get(i).getTeamName().toUpperCase() + " \0");
...
//						grp_A_point_table.get(i).getLost() + " \0");
...
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row" + row_id + "$RowAni$Highlight*ACTIVE SET 1 \0");
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row" + row_id + "$RowAni$Data$BowlerName*GEOM*TEXT SET " + 
//						grp_B_point_table.get(i).getTeamName().toUpperCase() + " \0");
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row" + row_id + "$RowAni$Data$ScoreGrp$OversValue*GEOM*TEXT SET " + 
//						grp_B_point_table.get(i).getPlayed() + " \0");
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row" + row_id + "$RowAni$Data$ScoreGrp$MaidensValue*GEOM*TEXT SET " + 
//						grp_B_point_table.get(i).getWon() + " \0");
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row" + row_id + "$RowAni$Data$ScoreGrp$RunsValue*GEOM*TEXT SET " + 
//						grp_B_point_table.get(i).getLost() + " \0");
//				print_writer.println("-1 RENDERER*TREE*$Main$All$Points_table$RowAll$Table$Row" + row_id + "$RowAni$Data$ScoreGrp$EconomyValue*GEOM*TEXT SET " + 
...
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path + 
//						team.get(plyr.get(playerId - 1).getTeamId() - 1).getTeamLogo().toUpperCase() + "\0");
//	
...
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamBadge" + row_id + " SET " + flag_path + 
//							fix.get(i).getHome_Team().getTeamLogo().toUpperCase() + "\0");
...
//					
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON tTime" + row_id + " SET " + "LIVE AT " + fix.get(i).getGmtTime() + 
//							" FROM " + fix.get(i).getVenue() + "\0");
//	
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgAwayTeamBadge" + row_id + " SET " + flag_path + 
//							fix.get(i).getAway_Team().getTeamLogo().toUpperCase() + "\0");
...
//						
//						if(fix.get(match_number - 1).getMatchnumber() < 10) {
//							print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$SummaryHeader*GEOM*TEXT SET " + "SUMMARY - " + "MATCH " + 
//									fix.get(match_number - 1).getMatchnumber() + "\0");
//						}else {
//							if(fix.get(match_number - 1).getMatchfilename().contains("_")) {
//								print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$SummaryHeader*GEOM*TEXT SET " + "SUMMARY - " + 
//										fix.get(match_number - 1).getMatchfilename().replace("_", " ").toUpperCase() + "\0");
//							}else {
//								print_writer.println("-1 RENDERER*TREE*$Main$All$Summary$SummaryHeader*GEOM*TEXT SET " + "SUMMARY - " + 
...
//							teamname_logo  = mtch.get(j).getSetup().getHomeTeam().getTeamLogo().toUpperCase() ;
//						} else {
//							teamname = mtch.get(j).getSetup().getAwayTeam().getTeamName1();
//							teamname_logo = mtch.get(j).getSetup().getAwayTeam().getTeamLogo().toUpperCase() ;
//						}
//						
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgSumTeamBadge" + i + " SET " + flag_path + teamname_logo + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row"+row_id+"$RowAni$Highlight$BatsmanName*GEOM*TEXT SET " + teamname.toUpperCase() + "\0");
...
//						}else {
//							print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row"+row_id+"$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " + mtch.get(j).getMatch().getInning().get(i-1).getTotalRuns() + slashOrDash + String.valueOf(mtch.get(j).getMatch().getInning().get(i-1).getTotalWickets()) + "\0");	
//						}
//						
//						print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row"+row_id+"$RowAni$Highlight$Overs*GEOM*TEXT SET " + 
...
//							print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row9$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " 
//									+ CricketFunctions.generateMatchSummaryStatus(2, match, CricketUtil.FULL, broadcaster).replace("win", "won").toUpperCase() + "\0");
//						}
...
//							print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row9$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " 
//									+ "MATCH TIED - " + mtch.get(j).getMatch().getMatchStatus().replace("win", "won").toUpperCase() + "\0");
//						}
//						else {
//							print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row9$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " 
//									+ mtch.get(j).getMatch().getMatchStatus().replace("win", "won").toUpperCase() + "\0");
//						}
//					}
//					else {
...
//								print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row9$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " 
//										+ mtch.get(j).getMatch().getMatchStatus().replace("win", "won").toUpperCase() + " (VJD)" + "\0");
//							}
//							else if(mtch.get(j).getSetup().getTargetType().toUpperCase().equalsIgnoreCase("DLS")) {
//								print_writer.println("-1 RENDERER*TREE*$Main$Summary$DataAll$Row9$RowAni$Highlight$BatsmanScore*GEOM*TEXT SET " 
//										+ mtch.get(j).getMatch().getMatchStatus().replace("win", "won").toUpperCase() + " (DLS)" + "\0");
//							}
//						}
...
//						team.get(plyr.get(playerId - 1).getTeamId() - 1).getTeamLogo().toUpperCase() + "\0");
//	
////				print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$All_Brushes$noname$TeamBadge*TEXTURE*IMAGE SET " + flag_path + 
...
//											CricketFunctions.generateMatchSummaryStatus(2, match, CricketUtil.FULL, broadcaster).toUpperCase() + ";");
//									//print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tResult " + match.getMatchStatus().toUpperCase() + ";");
//								}
//							}
//							else {
...
//										
//									print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBottomInfo " + 
//											CricketFunctions.generateMatchSummaryStatus(2, match, CricketUtil.FULL, broadcaster).toUpperCase() + " (VJD)" + ";");
//									}
//								}
//							}
//							//print_writer.println("LAYER1*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tBottomInfo " + "BOUNDARIES " + inn.getTotalFours() + "FOURS " + inn.getTotalSixes() + " SIXES" + ";");
...
//												CricketFunctions.generateRunRate(CricketFunctions.getRequiredRuns(match), 0, CricketFunctions.getRequiredBalls(match), 2,match) + ";");
//						}
//					}
//					break;
//				case "COMPARISION":
...
//					if(j <= match.getMatch().getInning().get(whichInning - 1).getFirstPowerplayEndOver() || 
//						(j>= match.getMatch().getInning().get(whichInning - 1).getThirdPowerplayStartOver() && 
//							j <= match.getMatch().getInning().get(whichInning - 1).getThirdPowerplayEndOver())) {
...
//					
//					if(j>=1 && j<=24) {
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll1$Bar" + (j) + "*ACTIVE SET 0" + "\0");
//					}else if(j>=25 && j<=48) {
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll2$Bar" + (j) + "*ACTIVE SET 0" + "\0");
//					}else if(j>=49 && j<=50) {
//						print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll3$Bar" + (j) + "*ACTIVE SET 0" + "\0");
//					}
//					
...
//						if(j>=1 && j<=24) {
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll1$Bar" + (j) + "*ACTIVE SET 1" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll1*FUNCTION*BarValues*Bar_Value__" + (j) + " SET " + lngth + "\0");
//						}else if(j>=25 && j<=48) {
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll2$Bar" + (j) + "*ACTIVE SET 1" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll2*FUNCTION*BarValues*Bar_Value__" + (j-24) + " SET " + lngth + "\0");
//						}else if(j>=49 && j<=50) {
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll3$Bar" + (j) + "*ACTIVE SET 1" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$TeamAll1$BarGrp$BarAll3*FUNCTION*BarValues*Bar_Value__" + (j-48) + " SET " + lngth + "\0");
//						}
//						
...
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamLogo" + " SET " + "IMAGE*/Default/ACC/Logos/ACC_Logo" + "\0");
//				
//				if(CricketFunctions.getRequiredRuns(match) > 0 || match.getMatch().getInning().get(1).getTotalWickets() >= 10 
//						|| match.getMatch().getInning().get(1).getTotalOvers() >= match.getSetup().getMaxOvers()) {
//					
...
//		}
//	}
//	public void populateBatGriff(PrintWriter print_writer,String viz_scene,int whichinning, int PlayerId, List<Tournament> tournament_high_score,List<Team> team,MatchAllData match ,String session_selected_broadcaster, Configuration config) throws InterruptedException 
//	{
//		int row_no = 0;
//		switch (session_selected_broadcaster.toUpperCase()) {
//		case "ACC":
...
//					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + photo_path + 
//								team.get(top_ten_beststat.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\\\\" + 
//								top_ten_beststat.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//					}else {
//						if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +team.get(top_ten_beststat.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase()
//								+ "\\\\" + top_ten_beststat.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//							this.status = CricketUtil.UNSUCCESSFUL;
//						}
...
//					
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path + 
//							team.get(top_ten_beststat.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\0");
//	
...
//		}
//	}
//	public void populateBallGriff(PrintWriter print_writer,String viz_scene,int whichinning, int PlayerId, List<Tournament> tournament_high_score,List<Team> team,MatchAllData match ,String session_selected_broadcaster, Configuration config) throws InterruptedException 
//	{
//		int row_no = 0;
//		switch (session_selected_broadcaster.toUpperCase()) {
//		case "ACC":
...
//					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + photo_path + 
//								team.get(top_bowler_beststats.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\\\\" + 
//								top_bowler_beststats.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0");
//					}else {
//						if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +team.get(top_bowler_beststats.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase()
//								+ "\\\\" + top_bowler_beststats.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//							this.status = CricketUtil.UNSUCCESSFUL;
//						}
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + "\\\\\\\\"+config.getPrimaryIpAddress()+"\\\\"+local_photo_path + 
//								team.get(top_bowler_beststats.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\\\\" + 
...
//					
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path + 
//							team.get(top_bowler_beststats.get(i).getPlayer().getTeamId() - 1).getTeamLogo().toUpperCase() + "\0");
//					
...
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + photo_path 
//										+ match.getSetup().getHomeTeam().getTeamLogo() + "\\\\" + this_series.get(i).getPlayer().getPhoto() + ".png" + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getHomeTeam().getTeamLogo()
...
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + photo_path 
//										+ match.getSetup().getAwayTeam().getTeamLogo() + "\\\\" + this_series.get(i).getPlayer().getPhoto() + ".png" + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +match.getSetup().getAwayTeam().getTeamLogo()
//										+ "\\\\" + this_series.get(i).getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION).exists()) {
//									this.status = CricketUtil.UNSUCCESSFUL;
...
//						}
//						
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tFirstName" + " SET " + this_series.get(i).getPlayer().getFirstname().toUpperCase() + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tLastName" + " SET " + this_series.get(i).getPlayer().getSurname().toUpperCase() + "\0");
//	
//						switch(TypeofProfile.toUpperCase()) {
//						case CricketUtil.BATSMAN:
//							print_writer.println("-1 RENDERER*TREE*$Main$All$DataAll$Row1$RowAnimation$StatHead*GEOM*TEXT SET " + "MATCHES" + "\0");
...
//					
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path + 
//						match.getMatch().getInning().get(1).getBatting_team().getTeamLogo() + "\0");
...
//	}
//	
//	public void populateFFInnBuilder(PrintWriter print_writer,String viz_scene,int whichInning,int playerId,List<Player> players,List<Team> teams, MatchAllData match, String broadcaster, Configuration config)
//	{
//		if (match == null) {
//			this.status = "ERROR: Match is null";
//		} else {
...
//							
//							print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgTeamBadge" + " SET " + flag_path + 
//									teams.get(bc.getPlayer().getTeamId()-1).getTeamLogo().toUpperCase() + "\0");
//							if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
//								print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgPlayerImage" + " SET " + photo_path +
//										teams.get(bc.getPlayer().getTeamId()-1).getTeamLogo().toUpperCase() + "\\\\" + bc.getPlayer().getPhoto() + 
//										CricketUtil.PNG_EXTENSION + "\0");
//							}else {
//								if(!new File("\\\\"+config.getPrimaryIpAddress()+"\\c\\Images\\ACC\\Photos\\" +teams.get(bc.getPlayer().getTeamId()-1).getTeamLogo().toUpperCase()
...
//								runsIncr*(i+1) + "\0");
//						
//						print_writer.println("-1 RENDERER*TREE*$Main$All$BarAll$Bar$BarGrp$BarAll1$Bar" + (i+1) + "*ACTIVE SET 0" + "\0");
//						print_writer.println("-1 RENDERER*TREE*$Main$All$BarAll$Bar$BarGrp$BarAll2$Bar" + (i+1) + "*ACTIVE SET 0" + "\0");
//					}
//					
//					
...
//						row_id = 5 - i;
//						if(row_id <= 5) {
//							lngth = ((110 * Integer.valueOf(CricketFunctions.getPlayerSplit(whichInning,playerId,runsIncr,total_balls,match,match.getEventFile().getEvents()).get(i))) / 
//									(double)maxRuns);
//							//System.out.println("SIZE : " + lngth);
//							print_writer.println("-1 RENDERER*TREE*$Main$All$BarAll$Bar$BarGrp$BarAll1$Bar" + (row_id) + "*ACTIVE SET 1" + "\0");
//							print_writer.println("-1 RENDERER*TREE*$Main$All$BarAll$Bar$BarGrp$BarAll2$Bar" + (row_id) + "*ACTIVE SET 1" + "\0");
//							
...
//		}
//	}
//	public void populateRicheis(PrintWriter print_writer,String viz_scene, int whichInning, MatchAllData match, String session_selected_broadcaster)
//	{
//		switch (session_selected_broadcaster.toUpperCase()) {
//		case "ACC":
//			if (match == null) {
...
//		}	
//	}
//	public void populateLtPhaseByScore(PrintWriter print_writer,String viz_scene, MatchAllData match, String session_selected_broadcaster)
//	{
//		switch (session_selected_broadcaster.toUpperCase()) {
//		case "ACC":
//			if (match == null) {
...
//			} else {
//				
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "lgHomeTeamLogo" + " SET " + logo_path + "ACC_Logo" + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + " SET " + "INNINGS PROGRESSION" + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead1" + " SET " + "1-10" + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead2" + " SET " + "11-40" + "\0");
//				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tStatHead3" + " SET " + "41-50" + "\0");
//				
//				for(Inning inn : match.getMatch().getInning()) {
//					print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamName" + inn.getInningNumber() + " SET " + 
//							inn.getBatting_team().getTeamName1().toUpperCase() + "\0");
//					
//					if(CricketFunctions.getFirstPowerPlayScore(match, inn.getInningNumber(), match.getEventFile().getEvents()).equalsIgnoreCase("0-0")) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamScore" + inn.getInningNumber() + "A" + " SET " + "-" + "\0");
//					}else {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamScore" + inn.getInningNumber() + "A" + " SET " + 
//								CricketFunctions.getFirstPowerPlayScore(match, inn.getInningNumber(), match.getEventFile().getEvents()) + "\0");
//					}
//					
//					if(CricketFunctions.getSecPowerPlayScore(match, inn.getInningNumber(), match.getEventFile().getEvents()).equalsIgnoreCase("0-0")) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamScore" + inn.getInningNumber() + "B" + " SET " + "-" + "\0");
//					}else {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamScore" + inn.getInningNumber() + "B" + " SET " + 
//								CricketFunctions.getSecPowerPlayScore(match, inn.getInningNumber(), match.getEventFile().getEvents()) + "\0");
//					}
//
//					if(CricketFunctions.getThirdPowerPlayScore(match, inn.getInningNumber(), match.getEventFile().getEvents()).equalsIgnoreCase("0-0")) {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamScore" + inn.getInningNumber() + "C" + " SET " + "-" + "\0");
//					}else {
//						print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tTeamScore" + inn.getInningNumber() + "C" + " SET " + 
//								CricketFunctions.getThirdPowerPlayScore(match, inn.getInningNumber(), match.getEventFile().getEvents()) + "\0");
//					}
//				}
//			}
//			print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_scene + " C:/Temp/Preview.png In 3.500 \0");
...
//			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*HighlightAll$Highlight" + lb_count + "_In START \0");
//			break;
//		case "BUG_PARTNERSHIP": case "MULTI_PARTNERSHIP": case "BUG_HIGHLIGHT": case "BUG-TOSS": case "BUG-DISMISSAL": case "BUG": case "BUGBOWLER": case "BUG-DB": case "HOWOUT": case "NAMESUPER": case "NAMESUPER-PLAYER": case "FALLOFWICKET": case "LTMATCH_PROMO":
...
//		case "BATSMAN_STYLE": case "MANHATTAN": case "PARTNERSHIP": case "HOWOUT_WITHOUT": case "MATCH_PROMO": case "MOSTRUNS": case "MOSTWICKETS": case "MOSTFOURS": 
//		case "MOSTSIXES": case "HIGHESTSCORE": case "WORM": case "QUICK_HOWOUT": case "SQUAD": case "TIEID-DOUBLE": case "FF_THIS-SERIES": case "MINI-SCORECARD": 
...
//		case "LT_THIS-SERIES": case "L3PLAYERPROFILE": case "LTPLAYERPROFILEBAT": case "FFPLAYERPROFILE": case "PLAYERPROFILEBALL": case "TEAMLINEUP": case "DOUBLETEAMS":
//		case "LANDMARK": case "EQUATION": case "POSITION_LANDMARK": case "BATSMAN_THIS_MATCH": case "BOWLER_THIS_MATCH": case "LTPOINTSTABLE": case "BOWLER_STYLE":
//		case "BATSMAN_STYLE": case "MANHATTAN": case "PARTNERSHIP": case "HOWOUT_WITHOUT": case "SQUAD": case "FF_THIS-SERIES": case "MOSTRUNS": case "MOSTWICKETS":
//		case "MOSTFOURS": case "MOSTSIXES": case "HIGHESTSCORE": case "WORM": case "LTMATCH_PROMO": case "QUICK_HOWOUT": case "TIEID-DOUBLE": case "MINI-SCORECARD":
//		case "MINI-BOWLINGCARD": case "BUG_POWERPLAY": case "MANUAL": case "BATGRIFF": case "BALLGRIFF": case "PLAYOFF": case "DLS_TARGET":
//		case "DLS_EQUATION": case "LT_POINTERS": case "FF_POINTERS": case "FF_FIXTURES": case "FIXTURES_TEAM": case "TEAM_SQUAD": case "INN_BUILDER": case "RICHEIS":
//		case "PHASE_BY_SCORE":
//			print_writer.println("-1 RENDERER*STAGE*DIRECTOR*Out START \0");
